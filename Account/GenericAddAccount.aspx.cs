...
public partial class GenericAddAccount : MTAccountPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        Account.AccountStartDate = DateTime.Now;
            ...
            //MTGenericForm1.TemplateName = "Add." + MTGenericForm1.RenderObjectType.Name; // Customized to use separate templates for summary, add and update account pages
            MTGenericForm1.ReadOnly = false;
            SetupSkipProperties();
            MTGenericForm1.IgnoreProperties = skipProperties;

            // Initialization added to enable tax panel for all account types 
