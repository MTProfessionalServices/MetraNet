...
/////////////////////////////////////////////////////////////////////////////
// CActive
class ATL_NO_VTABLE CActive : 
	public ISupportErrorInfo,
	public MTAccountStateImpl<CActive,&CLSID_Active>
{
public:
	CActive()
	{
...
DECLARE_REGISTRY_RESOURCEID(IDR_ACTIVE)
DECLARE_GET_CONTROLLING_UNKNOWN()

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CActive)
...
protected:
  ...
  void IsAccBillableAndPayingForOthers(long lAccountID, DATE StartDate, long& lRetVal);
  void CheckForNotClosedDescendents(long lAccountID, DATE RefDate, long& lRetVal);
  void UpdateDBState(long lAccountID, _bstr_t bstrNewState, DATE StartDate, MTACCOUNTSTATESLib::IMTSQLRowsetPtr& rowset);
	MTAutoInstance<MTAutoLoggerImpl<aActiveLogTitle> > mLogger;
