...
#ifndef __SUSPENDED_H_
#define __SUSPENDED_H_
...
/////////////////////////////////////////////////////////////////////////////
// CSuspended
class ATL_NO_VTABLE CSuspended : 
	public MTAccountStateImpl<CSuspended, &CLSID_Suspended>,
...
DECLARE_REGISTRY_RESOURCEID(IDR_SUSPENDED)
DECLARE_GET_CONTROLLING_UNKNOWN()

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CSuspended)
...
protected:
  ...
  void UpdateDBState(long lAccountID, _bstr_t bstrNewState, DATE StartDate, MTACCOUNTSTATESLib::IMTSQLRowsetPtr& rowset);
	MTAutoInstance<MTAutoLoggerImpl<aSuspendedLogTitle> > mLogger;
	
};

#endif //__SUSPENDED_H_
