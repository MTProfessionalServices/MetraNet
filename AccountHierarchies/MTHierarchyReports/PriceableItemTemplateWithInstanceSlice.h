...
// PriceableItemTemplateWithInstanceSlice.h : Declaration of the CPriceableItemTemplateWithInstanceSlice

#ifndef __PriceableItemTemplateWithInstanceSlice_H_
#define __PriceableItemTemplateWithInstanceSlice_H_
...
class ATL_NO_VTABLE CPriceableItemTemplateWithInstanceSlice : 
	public CComObjectRootEx<CComMultiThreadModel>,
	public CComCoClass<CPriceableItemTemplateWithInstanceSlice, &CLSID_PriceableItemTemplateWithInstanceSlice>,
	public ISupportErrorInfo,
	public SingleProductViewSliceImpl<IPriceableItemTemplateWithInstanceSlice, &IID_IPriceableItemTemplateWithInstanceSlice, &LIBID_MTHIERARCHYREPORTSLib>
{
public:
	CPriceableItemTemplateWithInstanceSlice() :
		mTemplateID(-1),
...
DECLARE_REGISTRY_RESOURCEID(IDR_PRICEABLEITEMTEMPLATEWITHINSTANCESLICE)
DECLARE_GET_CONTROLLING_UNKNOWN()

DECLARE_PROTECT_FINAL_CONSTRUCT()

BEGIN_COM_MAP(CPriceableItemTemplateWithInstanceSlice)
	COM_INTERFACE_ENTRY(IPriceableItemTemplateWithInstanceSlice)
...
// IPriceableItemTemplateWithInstanceSlice
public:
...
#endif //__PriceableItemTemplateWithInstanceSlice_H_
