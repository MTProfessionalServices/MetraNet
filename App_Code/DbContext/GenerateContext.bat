...
%sqlmetal% /server:. /user:sa /password:MetraTech1 /database:AnalyticsDatamart /code:MetraNet.DbContext.DataMart.cs /namespace:MetraNet.DbContext /context:DataMart /language:csharp
