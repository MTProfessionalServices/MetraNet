...
namespace MetraNet.DbContext
{
    ...
    partial void DeleteSubscriptionTable(SubscriptionTable instance);
		...
		public System.Data.Linq.Table<Counter_summaries> Counter_summaries
		{
			get
			{
				return this.GetTable<Counter_summaries>();
			}
		}
		...
		public System.Data.Linq.Table<Decision_table> Decision_table
		{
			get
			{
				return this.GetTable<Decision_table>();
			}
		}
		...
		public System.Data.Linq.Table<Subscription_charges> Subscription_charges
		{
			get
			{
				return this.GetTable<Subscription_charges>();
			}
		}
	...
	[Table(Name="dbo.counter_summaries")]
	public partial class Counter_summaries
	{
		...
		private System.Nullable<decimal> _Total_minutes;
		
		private System.Nullable<decimal> _Total_overage_amount;
		
		private System.Nullable<decimal> _Qualified_overage_amount;
		
		private System.Nullable<decimal> _Qualified_overage_units;
		
		private System.Nullable<decimal> _Total_included_units_consumed;
		
		private System.Nullable<decimal> _Total_included_amount_credited;
		
		private System.Nullable<decimal> _Total_included_units;
		
		public Counter_summaries()
		{
		}
		
		[Column(Storage="_IntervalID", DbType="Int NOT NULL")]
		...
		[Column(Storage="_SubscriptionId", DbType="VarChar(20)")]
		...
		[Column(Name="total_minutes", Storage="_Total_minutes", DbType="Decimal(38,6)")]
		public System.Nullable<decimal> Total_minutes
		{
			get
			{
		...
		[Column(Name="total_overage_amount", Storage="_Total_overage_amount", DbType="Decimal(38,6)")]
		public System.Nullable<decimal> Total_overage_amount
		{
			get
			{
				return this._Total_overage_amount;
			}
			set
			{
				if ((this._Total_overage_amount != value))
				{
					this._Total_overage_amount = value;
				}
			}
		}
		
		[Column(Name="qualified_overage_amount", Storage="_Qualified_overage_amount", DbType="Decimal(38,6)")]
		public System.Nullable<decimal> Qualified_overage_amount
		{
			get
			{
				return this._Qualified_overage_amount;
			}
			set
			{
				if ((this._Qualified_overage_amount != value))
				{
					this._Qualified_overage_amount = value;
				}
			}
		}
		
		[Column(Name="qualified_overage_units", Storage="_Qualified_overage_units", DbType="Decimal(38,11)")]
		public System.Nullable<decimal> Qualified_overage_units
		{
			get
			{
				return this._Qualified_overage_units;
			}
			set
			{
				if ((this._Qualified_overage_units != value))
				{
					this._Qualified_overage_units = value;
				}
			}
		}
		
		[Column(Name="total_included_units_consumed", Storage="_Total_included_units_consumed", DbType="Decimal(38,2)")]
		public System.Nullable<decimal> Total_included_units_consumed
		{
			get
			{
				return this._Total_included_units_consumed;
			}
			set
			{
				if ((this._Total_included_units_consumed != value))
				{
					this._Total_included_units_consumed = value;
				}
			}
		}
		
		[Column(Name="total_included_amount_credited", Storage="_Total_included_amount_credited", DbType="Decimal(38,2)")]
		public System.Nullable<decimal> Total_included_amount_credited
		{
			get
			{
				return this._Total_included_amount_credited;
			}
			set
			{
				if ((this._Total_included_amount_credited != value))
				{
					this._Total_included_amount_credited = value;
				}
			}
		}
		
		[Column(Name="total_included_units", Storage="_Total_included_units", DbType="Decimal(38,6)")]
		public System.Nullable<decimal> Total_included_units
		{
			get
			{
				return this._Total_included_units;
			}
			set
			{
				if ((this._Total_included_units != value))
				{
					this._Total_included_units = value;
				}
			}
		}
	}
	...
	[Table(Name="dbo.decision_table")]
	public partial class Decision_table
	{
		...
		private string _Id_acc;
		
		private string _Id_sub;
		
		private string _Id_po;
		
		private string _Id_sched;
		
		private string _N_order;
		
		private System.Nullable<int> _DaysConsumed;
		
		private System.Nullable<double> _ProrationFactor;
		
		public Decision_table()
		{
		}
		
		[Column(Name="decision_unique_id", Storage="_Decision_unique_id", DbType="VarChar(400) NOT NULL", CanBeNull=false)]
		...
		[Column(Name="id_acc", Storage="_Id_acc", DbType="VarChar(100)")]
		...
		[Column(Name="id_sub", Storage="_Id_sub", DbType="VarChar(100)")]
		...
		[Column(Name="id_po", Storage="_Id_po", DbType="VarChar(100)")]
		public string Id_po
		{
			get
			{
		...
		[Column(Name="id_sched", Storage="_Id_sched", DbType="VarChar(100)")]
		public string Id_sched
		{
			get
			{
		...
		[Column(Name="n_order", Storage="_N_order", DbType="VarChar(100)")]
	...
	[Table(Name="dbo.Subscription_charges")]
	public partial class Subscription_charges
	{
	...
	public partial class SubscriptionPrice
	{
		...
		private System.Nullable<bool> _B_prorate_on_activate;
		
		private System.Nullable<bool> _B_prorate_on_deactivate;
		
		private System.Nullable<bool> _B_prorate_on_rate_change;
		...
		[Column(Name="b_prorate_on_activate", Storage="_B_prorate_on_activate", DbType="Bit")]
		public System.Nullable<bool> B_prorate_on_activate
		{
			get
			{
		...
		[Column(Name="b_prorate_on_deactivate", Storage="_B_prorate_on_deactivate", DbType="Bit")]
		public System.Nullable<bool> B_prorate_on_deactivate
		{
			get
			{
		...
		[Column(Name="b_prorate_on_rate_change", Storage="_B_prorate_on_rate_change", DbType="Bit")]
		public System.Nullable<bool> B_prorate_on_rate_change
		{
			get
			{
