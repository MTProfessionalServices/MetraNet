...
public partial class ApprovalFrameworkManagement_AjaxServices_GetChangeItemHistory : MTListServicePage
{
  ...
  {
      using (new HighResolutionTimer("GetChangeItemHistoryAjax", 5000))
    {
      ...
      try
      {
        ...
        MTList<ChangeHistoryItem> items = new MTList<ChangeHistoryItem>();
