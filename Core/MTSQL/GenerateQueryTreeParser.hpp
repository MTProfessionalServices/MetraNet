#ifndef INC_GenerateQueryTreeParser_hpp_
#define INC_GenerateQueryTreeParser_hpp_

#include <antlr/config.hpp>
#include "GenerateQueryTreeParserTokenTypes.hpp"
/* $ANTLR 2.7.6 (2005-12-22): "generate_query.g" -> "GenerateQueryTreeParser.hpp"$ */
...
#line 19 "GenerateQueryTreeParser.hpp"
class CUSTOM_API GenerateQueryTreeParser : public ANTLR_USE_NAMESPACE(antlr)TreeParser, public GenerateQueryTreeParserTokenTypes
{
#line 20 "generate_query.g"
...
#line 23 "GenerateQueryTreeParser.hpp"
public:
	GenerateQueryTreeParser();
	static void initializeASTFactory( ANTLR_USE_NAMESPACE(antlr)ASTFactory& factory );
	int getNumTokens() const
	{
		return GenerateQueryTreeParser::NUM_TOKENS;
	}
	const char* getTokenName( int type ) const
	{
		if( type > getNumTokens() ) return 0;
		return GenerateQueryTreeParser::tokenNames[type];
	}
	const char* const* getTokenNames() const
	{
		return GenerateQueryTreeParser::tokenNames;
	}
...
#endif /*INC_GenerateQueryTreeParser_hpp_*/
