#ifndef INC_MTSQLOracleTreeParser_hpp_
#define INC_MTSQLOracleTreeParser_hpp_

#include <antlr/config.hpp>
#include "MTSQLOracleTreeParserTokenTypes.hpp"
/* $ANTLR 2.7.6 (2005-12-22): "expandedmtsql_tree_oracle.g" -> "MTSQLOracleTreeParser.hpp"$ */
...
#line 29 "MTSQLOracleTreeParser.hpp"
class CUSTOM_API MTSQLOracleTreeParser : public ANTLR_USE_NAMESPACE(antlr)TreeParser, public MTSQLOracleTreeParserTokenTypes
{
#line 31 "expandedmtsql_tree_oracle.g"
...
#line 33 "MTSQLOracleTreeParser.hpp"
public:
	MTSQLOracleTreeParser();
	static void initializeASTFactory( ANTLR_USE_NAMESPACE(antlr)ASTFactory& factory );
	int getNumTokens() const
	{
		return MTSQLOracleTreeParser::NUM_TOKENS;
	}
	const char* getTokenName( int type ) const
	{
		if( type > getNumTokens() ) return 0;
		return MTSQLOracleTreeParser::tokenNames[type];
	}
	const char* const* getTokenNames() const
	{
		return MTSQLOracleTreeParser::tokenNames;
	}
...
#endif /*INC_MTSQLOracleTreeParser_hpp_*/
