#ifndef INC_MTSQLRefactorLexer_hpp_
#define INC_MTSQLRefactorLexer_hpp_

#include <antlr/config.hpp>
/* $ANTLR 2.7.6 (2005-12-22): "mtsql_refactor_lexer.g" -> "MTSQLRefactorLexer.hpp"$ */
...
#line 18 "MTSQLRefactorLexer.hpp"
class CUSTOM_API MTSQLRefactorLexer : public ANTLR_USE_NAMESPACE(antlr)CharScanner, public MTSQLTokenTypes
{
#line 112 "mtsql_refactor_lexer.g"
...
#line 22 "MTSQLRefactorLexer.hpp"
private:
	void initLiterals();
public:
...
public:
	MTSQLRefactorLexer(ANTLR_USE_NAMESPACE(std)istream& in);
	MTSQLRefactorLexer(ANTLR_USE_NAMESPACE(antlr)InputBuffer& ib);
	MTSQLRefactorLexer(const ANTLR_USE_NAMESPACE(antlr)LexerSharedInputState& state);
	...
	public: void mTK_VARCHAR(bool _createToken);
...
#endif /*INC_MTSQLRefactorLexer_hpp_*/
