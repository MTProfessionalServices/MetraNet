...
static DBViewHierarchy *pViewHierarchy = NULL ;
...
#if 0
    CoInitialize(NULL); 
    pViewHierarchy  = DBViewCollection::GetInstance() ;
    pServicesList = DBServicesCollection::GetInstance() ;
#endif
    break;
