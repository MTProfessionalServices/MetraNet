...
public partial class DataExportReportManagement_AjaxServices_GetAssignedReportParameters : MTListServicePage
{
  ...
  protected bool ExtractDataInternal(DataExportReportManagementServiceClient client, ref MTList<ExportReportParameters> items, int batchID, int limit)
  {
    try
    {
      ...
      client.GetAssignedReportDefinitionParametersInfo(IDReport, ref items);
  ...
  {
    using (new HighResolutionTimer("GetAssignedReportParametersAjax", 5000))
    {
