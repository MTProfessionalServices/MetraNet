...
public partial class DataExportReportManagement_AjaxServices_GetExportDashboardDetails : MTListServicePage
{
  ...
  protected bool ExtractDataInternal(DataExportReportManagementServiceClient client, ref MTList<ExportReportInstance> items, int batchID, int limit)
  {
    try
    {
      ...
      client.GetExportLogDashboard(ref items);
    }
  ...
  {
    using (new HighResolutionTimer("GetExportDashboardDetailsAjax", 5000))
    {
