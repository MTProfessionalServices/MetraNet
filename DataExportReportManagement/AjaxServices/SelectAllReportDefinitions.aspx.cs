...
public partial class DataExportReportManagement_AjaxServices_SelectAllReportDefinitions : MTListServicePage
{
  ...
  {
    using (new HighResolutionTimer("SelectAllReportDefinitionsAjax", 5000))
    {
