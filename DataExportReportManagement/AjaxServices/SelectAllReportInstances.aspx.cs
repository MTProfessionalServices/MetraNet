...
public partial class DataExportReportManagement_AjaxServices_SelectAllReportInstances : MTListServicePage
{
  ...
  protected bool ExtractDataInternal(DataExportReportManagementServiceClient client, ref MTList<ExportReportInstance> items, int batchID, int limit)
  {
    try
    {
      ...
      Logger.LogDebug("Getting the items in the list {0}..", Request["reportid"]);
      ...
      Logger.LogDebug("Getting the items in the list..");
      
      client.GetAllInstancesOfAReport(ref items, IDReport);

      Logger.LogDebug("Successfully obtained the items list");
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    using (new HighResolutionTimer("SelectAllReportInstancesAjax", 500000))
    {
