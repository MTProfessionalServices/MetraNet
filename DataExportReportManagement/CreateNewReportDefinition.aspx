<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NoMenuPageExt.master"
  AutoEventWireup="true" CodeFile="CreateNewReportDefinition.aspx.cs" Inherits="DataExportReportManagement_CreateNewReportDefinition"
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <!-- Title Bar -->
  <MT:MTTitle ID="MTTitle1" Text="Create New Report Definition" runat="server" meta:resourcekey="MTTitle1Resource1" />
  <br />
  <br />
  ...
  <MT:MTPanel ID="rptPanel" runat="server" meta:resourcekey="MTSection2Resource1" Collapsible="False"
    ...
    <div id="leftColumn" class="LeftColumn">
      <MT:MTTextBoxControl ID="tbReportTitle" runat="server" AllowBlank="True" Label="Report Title"
        ...
        LabelWidth="120" meta:resourcekey="tbReportTitleResource1" ReadOnly="False" XTypeNameSpace="form"
