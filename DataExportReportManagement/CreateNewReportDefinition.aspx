<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NoMenuPageExt.master" AutoEventWireup="true" CodeFile="CreateNewReportDefinition.aspx.cs" Inherits="DataExportReportManagement_CreateNewReportDefinition" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <!-- Title Bar -->
  <MT:MTTitle ID="MTTitle1" Text="Create New Report Definition" runat="server" meta:resourcekey="MTTitle1Resource1" /><br />
...
<!-- From Add Parameters Template -->
  ...
  <div id="leftColumn" class="LeftColumn">
      ...
      meta:resourcekey="tbReportTitleResource1" ReadOnly="False"  
