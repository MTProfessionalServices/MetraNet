<%@ Page Language="C#" MasterPageFile="~/MasterPages/NoMenuPageExt.master" AutoEventWireup="true" Inherits="DataExportReportManagement_ManageReportInstanceSchedules"
  Title="Manage Report Instance Schedule" Culture="auto" UICulture="auto" CodeFile="ManageReportInstanceSchedules.aspx.cs" meta:resourcekey="PageResource1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    OverrideRenderer_<%= MyGrid1.ClientID %> = function(cm)
  {
    ...
    //cm.setRenderer(cm.getIndexById('ScheduleType'), reportinstancescheduletypeColRenderer);
  ...
  function idreportinstancescheduleColRenderer(value, meta, record, rowIndex, colIndex, store)
  {
    ...
    str += String.format("&nbsp;&nbsp;<a style='cursor:hand;' id='manage_{0}' title='{2}' href='JavaScript:editreportinstanceschedule(\"{0}\", \"{1}\");'><img src='/Res/Images/icons/database_edit.png' alt='{2}' /></a>", record.data.IDSchedule, ScheduleTypeTextEncoded, "Update Report Instance Schedule");   
    str += String.format("&nbsp;&nbsp;<a style='cursor:hand;' id='manage_{0}' title='{2}' href='JavaScript:deletereportinstanceschedule(\"{0}\", \"{1}\");'><img src='/Res/Images/icons/database_delete.png' alt='{2}' /></a>", record.data.IDSchedule, ScheduleTypeTextEncoded, "Delete Report Instance Schedule");
