<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/NoMenuPageExt.master" AutoEventWireup="true" CodeFile="UpdateExistingReportDefinition.aspx.cs" Inherits="DataExportReportManagement_UpdateExistingReportDefinition" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <!-- Title Bar -->
  <MT:MTTitle ID="MTTitle1" Text="Update Existing Report Definition" runat="server" meta:resourcekey="MTTitle1Resource1" /><br />
...
<!-- From Add Parameters Template -->
  <MTCDT:MTGenericForm ID="MTGenericForm1" runat="server" 
    ...
    meta:resourcekey="MTGenericForm1Resource1" EnableChrome="True">
     ...
     <MT:MTPanel ID="rptPanel" runat="server"  
  ...
  <div id="leftColumn" class="LeftColumn">
      ...
      <MT:MTTextBoxControl ID="tbReportTitle" runat="server" 
      AllowBlank="True" Label="Report Title"
      ...
      meta:resourcekey="tbReportTitleResource1" ReadOnly="True"  
      XTypeNameSpace="form" LabelSeparator=":" Listeners="{}" MaxLength="-1" 
      MinLength="0" ValidationRegex="null" XType="TextField" />

    <MT:MTTextBoxControl ID="tbReportDescription" runat="server" 
      AllowBlank="True" Label="Description"
      TabIndex="20" ControlWidth="200" OptionalExtConfig="minLength:0,
                              maxLength:Number.MAX_VALUE,
                              regex:null,maxLength:50"  ControlHeight="18" 
      HideLabel="False" LabelWidth="120"    
      meta:resourcekey="tbReportDescriptionResource1" ReadOnly="False"  
      XTypeNameSpace="form" LabelSeparator=":" Listeners="{}" MaxLength="-1" 
      MinLength="0" ValidationRegex="null" XType="TextField" />

  <MT:MTDropDown ID="ddQueryTagList" runat="server" AutoPostBack="True" Label="Query Tag" HideLabel="False" LabelWidth="80"  
  meta:resourcekey="ddQueryTagListResource1"></MT:MTDropDown>

    <MT:MTCheckBoxControl ID="chkPreventAdhocExecution" runat="server" 
      AllowBlank="True"  BoxLabel="Prevent Adhoc Execution"
      TabIndex="5" meta:resourcekey="chkPreventAdhocExecutionResource1" 
      ReadOnly="False" Checked="False" HideLabel="False" Listeners="{}" 
      Name="chkPreventAdhocExecution" OptionalExtConfig="boxLabel:'Prevent Adhoc Execution',
                                            inputValue:'',
    ...
    <center>  
      <table cellspacing="0">
        <tr>
          ...
          <td  class="x-panel-btn-td">
            <MT:MTButton ID="MTButton3" runat="server" 
              Text="Manage Report Parameters" OnClick="btnManageReportParameters_Click" 
...
<MT:MTDataBinder ID="MTDataBinder1" runat="server">
    <DataBindingItems>
      <MT:MTDataBindingItem ID="MTDataBindingItem1" runat="server" BindingSource="exportreportdefinition" 
        BindingSourceMember="ReportQueryTag" ControlId="ddQueryTagList" BindingProperty="SelectedValue" ErrorMessageLocation="RedTextAndIconBelow">
      ...
      <MT:MTDataBindingItem ID="MTDataBindingItem4" runat="server" BindingProperty="Checked"
        BindingSource="exportreportdefinition" BindingSourceMember="bPreventAdhocExecution" ControlId="chkPreventAdhocExecution"
