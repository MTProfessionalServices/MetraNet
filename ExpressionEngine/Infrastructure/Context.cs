...
namespace MetraTech.ExpressionEngine
{
    ...
    public class Context
    {
        ...
        public Context(Context masterContext, Expression expression, EmailInstance emailInstance)
        {
            ...
            //Add property bag types that are generically supported by the expression
            ...
            //Add entities that are specified as parameters
            PropertyBagManager = masterContext.PropertyBagManager;
            foreach (var entityParameterName in Expression.EntityParameters)
            {
                var masterPropertyBag = GetPropertyBag(entityParameterName);
        ...
        {
            if (Expression == null)
                return new ExpressionParseResults();
