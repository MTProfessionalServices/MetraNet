INSERT INTO t_export_report_instance
           ...
           ,c_control_file_delivery_location
           ,c_ds_id
           ,c_compressreport
           ,c_compressthreshold
     ...
     VALUES
           ('DiscSchedNoParCSV1'
           ,(select TOP(1) id_rep from t_export_reports WHERE c_report_title='Report1-DiscSchedNoParCSV')
           ,0
           ,'19-Sep-12'
           ,'19-Sep-32'
           ,'CSV'
...
INSERT INTO t_export_report_instance
     ...
     VALUES
           ('DiscSchedNoParXML1'
           ,(select TOP(1) id_rep from t_export_reports WHERE c_report_title='Report2-DiscSchedNoParXML')
           ,0
           ,'19-Sep-12'
           ,'19-Sep-32'
           ,'XML'
