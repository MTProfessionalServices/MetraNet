...
FUNCTION Form_Initialize(EventArg) ' As Boolean
  ...
  set Rowset2 = PS.GetPCardUpdateRowset("__GET_PCARD_DETAILS__",  MAM().Subscriber("_AccountId"), request.QueryString("Account_Number"), request.QueryString("Account_Type"))  
  ...
  'Service.Properties("customerreferenceid").Value = Rowset.value("nm_customer")
  Service.Properties("bankname").Value            = Rowset.value("nm_bankname")  

  If IsValidObject(Rowset2.Value(0)) Then
    response.write mam_getDictionary("TEXT_ERROR_ROWSET")
    response.end
  End If  
   
  Service.Properties("customerreferenceid").Value = Rowset2.value("nm_customerreferenceid")
  Service.Properties("customervatnumber").Value   = Rowset2.value("nm_customervatnumber")
  Service.Properties("companyaddress").Value      = Rowset2.value("nm_companyaddress")
  Service.Properties("companypostalcode").Value   = Rowset2.value("nm_companypostalcode")
  Service.Properties("companyphone").Value        = Rowset2.value("nm_companyphone")
