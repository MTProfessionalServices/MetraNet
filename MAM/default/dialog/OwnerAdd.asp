...
Form.RouteTo = mam_GetDictionary("OWNER_ACCOUNTS_DIALOG")
...
FUNCTION OK_Click(EventArg) ' As Boolean
  ...
  If Form.Grids("DropGrid").Rowset.recordCount = 1 Then
      ...
      Call mgr.AddOwnership(GetAssociationAsOwned(mgr, CLng(Form.Grids("DropGrid").Properties("id").value)))
  ...
  Else
      ...
      For Each acc in GetAccountIDCollection()
        Call col.add(GetAssociationAsOwned(mgr, acc))
      Next
