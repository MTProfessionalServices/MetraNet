...
PRIVATE FUNCTION Form_LoadProductView(EventArg) ' As Boolean
  ...
  Service.Properties("dt_crt").Format = FrameWork.GetDictionary("DATE_TIME_FORMAT") 
  Service.Properties("Time").Format = FrameWork.GetDictionary("DATE_TIME_FORMAT")
  ...
  if len(rowset2.value("nm_name"))>0 then
    Service.Properties("PriceListName") = rowset2.value("nm_name")
  else
