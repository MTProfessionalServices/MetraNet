...
PRIVATE FUNCTION Form_Initialize(EventArg) ' As Boolean
  ...
  Else
      ...
      Form.HelpFile = "PO.Discount.ViewEdit.hlp.htm" ' Set the help file name
    ...
    Service.Properties.Add "disc_ve_name", "String",  1024, FALSE, TRUE
    Service.Properties("disc_ve_name") = SafeForHtml(COMObject.Instance.Name)
