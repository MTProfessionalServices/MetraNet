...
PUBLIC FUNCTION Form_Refresh(EventArg)
	' ESR-2970 reverted CR14260 that was done erroneously, this button maintains "extended billing cycle relative" this functionality is valid
	' call ".Add" with TRUE shows the button, FALSE hides the button
...
PRIVATE FUNCTION Ok_Click(EventArg) ' As Boolean
    ...
    If Not ProductCatalogHelper.UpdateForUDRC(EventArg) Then Exit Function
