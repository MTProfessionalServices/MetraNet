...
if len(Request.QueryString("CopyRateScheduleId"))=0 then
  session("CopyRateScheduleId") = ""
else
  session("CopyRateScheduleId") = Request.QueryString("CopyRateScheduleId")
end if
...
<html>
  <head>
    <script language="Javascript">
      ...
      //window.open('Wizard.asp?Path=<%=gobjMTWizard.Path%>&PageiD=<%=gobjMTWizard.CurrentPage%>', '_blank', 'height=400,width=600,resizable=no,scrollbars=yes');
    </script>
  </head>
  <body>
  </body>
