...
PRIVATE FUNCTION Form_DisplayEndOfPage(EventArg) ' As Boolean
    ...
    strTmp = "</table><div align=center><BR><BR><button  onclick='mdm_RefreshDialog(this); return false;' name='refresh' Class='clsOkButton'>Refresh</button><button  name='CLOSE' Class='clsOkButton' onclick='window.close(); return false;'>Close</button>" & vbNewLine
