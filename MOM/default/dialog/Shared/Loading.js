...
if(n) { 
  ...
  if(n) {
    document.write('.' + strLoadingClass + '{position:absolute;left:0px;top:0px;visibility:' + hiding + ';z-index:100;}');
//   	document.write('.' + strPageClass + '{position:absolute;left:20px;top:20px;visibility:' +  showing+ ';z-index:101;}');
  } else {
    document.write('.' + strLoadingClass + '{position:absolute;width=100%;height=100%;left:0px;top:0px;visibility:' + showing + ';z-index:100;}');
