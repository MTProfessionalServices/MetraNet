...
PRIVATE FUNCTION Form_Initialize(EventArg) ' As Boolean
    ...
    Form("StartTime") = request.QueryString("StartTime")
    Form("EndTime") = request.QueryString("EndTime")
...
PRIVATE FUNCTION Form_LoadProductView(EventArg) ' As Boolean
  ...
  dim dtStart,dtEnd
  dtStart=CDate(Form("StartTime"))
  dtEnd=CDate(Form("EndTime"))
  ...
  'response.write(Form("QueryTag"))
  'response.end
  
  '//START_TIME is optional
  if InStr(rowset.GetRawQueryString(true),"%%START_TIME%%")<>0 then
    rowset.AddParam "%%START_TIME%%", CDate(dtStart)
  end if
  
  '//END_TIME is optional
  if InStr(rowset.GetRawQueryString(true),"%%END_TIME%%")<>0 then
    rowset.AddParam "%%END_TIME%%", CDate(dtEnd)
  end if
  ...
  Service.Properties.Add "QueryParamBatchId", "string", 255, False, 0, eMSIX_PROPERTY_FLAG_NOT_STORED_IN_ROWSET
  Service.Properties("QueryParamBatchId").Value=Form("BatchId")
...
PRIVATE FUNCTION Form_DisplayEndOfPage(EventArg) ' As Boolean
    ...
    strTmp = "</table><br><div id='DebugInfo' style='visibility:hidden;position:relative; left: 10px;'><table border='0' cellpadding='1' cellspacing='0' width='95%' style='background-color:WhiteSmoke;font-size:10px; font-family: Tahoma, Verdana, Arial, Helvetica, sans-serif; color:black; BORDER-BOTTOM: black solid 1px;	BORDER-LEFT: gray solid 1px;	BORDER-RIGHT: black solid 1px; BORDER-TOP: gray solid 1px;'><tr><td>&nbsp;</td><td style='BORDER-BOTTOM: black solid 1px;'><strong><font style='font-size:10px'>Query Information:</font></strong>&nbsp;<td width='14px' height='18px'><a href='#' onClick='hideDebugInfo();'><img src='/mom/default/localized/us/images/hide.gif' border='0' alt='Close' onMouseOver='showBorder(this);' onMouseOut='hideBorder(this);'></a></td><br><tr><td>&nbsp;</td><td style='font-size:10px'><strong>Query Tag:</strong> " & Service.Properties("QueryTag").Value & "<br><strong>Start Date:</strong> " & Form("StartTime") & "<br><strong>End Date:</strong> " & Form("EndTime") & "<br><strong>Language Id:</strong> " & Service.Properties("QueryParamLanguageId") & "<br><strong>Query:</strong><br>" & Service.Properties("QueryString") & "<br></td><td>&nbsp;</td></tr></table><br></div>"
    strEndOfPageHTMLCode = strEndOfPageHTMLCode & strTmp
    strTmp = "<div id='ShowDebugInfo' style='vertical-align: top;position: relative; top: -100px; left: 10px'><a href='#' onClick='showDebugInfo();' title='Show Detailed Database Query Information'><img style='vertical-align: middle;' src='/mom/default/localized/us/images/infosmall.gif' border='0' alt='Show Detailed Database Query Information'></a> <a href='#' onClick='showDebugInfo();' title='Show Detailed Database Query Information'><font style='vertical-align: middle;font:10px'>Show Query Information</font></a></div>"
    strEndOfPageHTMLCode = strEndOfPageHTMLCode & strTmp
