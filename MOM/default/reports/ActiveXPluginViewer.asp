...
document.writeln('Param_URL="' + location.protocol + '//' + location.host + '/mci/mtreports/rptserver.asp" ');
document.writeln('Param_EnableExportButton="true" ');
document.writeln('Param_EnableHelpButton="true" ');
document.writeln('Param_DisplayGroupTree="false" ');
document.writeln('Param_DisplayToolbar="true" ');
document.writeln('Param_EnableGroupTree="false" ');
