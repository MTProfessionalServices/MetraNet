...
STDMETHODIMP CMTCreateGroupSubCapability::InterfaceSupportsErrorInfo(REFIID riid)
{
...
HRESULT CMTCreateGroupSubCapability::FinalConstruct()	
{
...
STDMETHODIMP CMTCreateGroupSubCapability::Implies(IMTCompositeCapability* aDemandedCap, 
