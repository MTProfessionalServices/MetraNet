...
STDMETHODIMP CMTModifyGroupSubMemberCapability::InterfaceSupportsErrorInfo(REFIID riid)
{
...
HRESULT CMTModifyGroupSubMemberCapability::FinalConstruct()	
{
  MTAUTHLib::IMTSecurityPtr mSec(__uuidof(MTAUTHLib::MTSecurity));
  mViewGroupSub = mSec->GetCapabilityTypeByName(VIEW_SUBCAP);
...
STDMETHODIMP CMTModifyGroupSubMemberCapability::Implies(IMTCompositeCapability* aDemandedCap, 
