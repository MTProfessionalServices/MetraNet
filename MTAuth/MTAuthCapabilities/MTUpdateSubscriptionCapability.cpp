...
STDMETHODIMP CMTUpdateSubscriptionCapability::InterfaceSupportsErrorInfo(REFIID riid)
{
...
HRESULT CMTUpdateSubscriptionCapability::FinalConstruct()	
{
  try
  {
...
STDMETHODIMP CMTUpdateSubscriptionCapability::Implies(IMTCompositeCapability* aDemandedCap, 
