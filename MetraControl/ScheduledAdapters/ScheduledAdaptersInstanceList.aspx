...
<script type="text/javascript">
  ...
  {
    var strUrl = "";
    str += String.format("<a style='cursor:pointer;' id='View'  href='/MetraNet/TicketToMOM.aspx?URL=/MOM/default/dialog/AdapterManagement.Instance.ViewEdit.asp?ID={0}&ReturnUrl={1}'>{0}</a>", value, encodeURIComponent("/MetraNet/MetraControl/ScheduledAdaptersInstanceList.aspx?AdapterName=<%=AdapterNameBase64%>&ID=<%=IdAdapter%>")); 
    return str;
  }
