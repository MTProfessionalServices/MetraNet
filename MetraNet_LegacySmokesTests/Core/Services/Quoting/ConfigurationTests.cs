...
namespace MetraTech.Core.Services.Test.Quoting
{
    ...
    public class ConfigurationTests
    {
        ...
        public void WriteConfigurationToFile()
        {
            ...
            configurationToWrite.IsAllowedUseActivityService = DEFAULT_IS_ALLOWED_USE_ACTIVITY_SERVICE_FOR_QUOTE_CREATION;
            ...
            Assert.AreEqual(configurationToWrite.IsAllowedUseActivityService, readConfiguration.IsAllowedUseActivityService);
