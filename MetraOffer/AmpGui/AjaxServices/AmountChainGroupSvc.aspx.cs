...
// Loads all the Amount Chain Groups into a grid.
public partial class AjaxServices_AmountChainGroupSvc : MTListServicePage
{
    ...
    protected bool ExtractDataInternal(AmpServiceClient client, ref MTList<DistinctNamedPvToAmountChainMapping> items, int batchID, int limit)
    {
        try
        {
            items.Items.Clear();
            ...
            client.GetDistinctNamedPvToAmountChainMappings(ref items);
        }
        catch (Exception ex)
        {
    ...
    protected bool ExtractData(AmpServiceClient client, ref MTList<DistinctNamedPvToAmountChainMapping> items)
    {
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        using (new HighResolutionTimer("AmountChainGroupSvcAjax", 5000))
        {
             ...
             try
             {
               ...
               MTList<DistinctNamedPvToAmountChainMapping> items = new MTList<DistinctNamedPvToAmountChainMapping>();
