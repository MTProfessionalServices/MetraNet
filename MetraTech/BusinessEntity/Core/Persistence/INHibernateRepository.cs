...
namespace MetraTech.BusinessEntity.Core.Persistence
{
    ...
    /// assembly.  For looser coupling, the "Core" layers of the MetraTech.Basic library 
    /// and of your application should not have a reference to the NHibernate assembly.
    /// </summary>
