...
namespace MetraTech.BusinessEntity.DataAccess.Metadata
{
    ...
    /// This may be used for comparing objects of type <see cref="BaseBmeObject" /> and anything 
    ...
    /// </summary>
    public class BaseObjectEqualityComparer<T> : IEqualityComparer<T> where T : BaseBmeObject
    {
