...
{
    public class AdjustmentInstance : BaseObject
    {
        #region ID
        [DataMember(IsRequired = false, EmitDefaultValue = false)]
        private bool isIDDirty = false;
        private int? m_ID;
        [MTDataMember(Description = "This is the internal identifier of the adjustment instance", Length = 40)]
        [DataMember(IsRequired = false, EmitDefaultValue = false)]
        public int? ID
        {
            get { return m_ID; }
        ...
        [MTDataMember(Description = "This is the name of the adjustment instance.", Length = 40)]
        [DataMember(IsRequired = false, EmitDefaultValue = false)]
        public string Name
        {
            get { return m_Name; }
        ...
        [MTDataMember(Description = "This is the default name for the adjustment instance.", Length = 40)]
        [DataMember(IsRequired = false, EmitDefaultValue = false)]
        ...
        [MTDataMember(Description = "This is the collection of localized display names for the adjustment instance.", Length = 40)]
        [DataMember(IsRequired = false, EmitDefaultValue = false)]
