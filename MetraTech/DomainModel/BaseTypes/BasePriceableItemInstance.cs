...
{
    [Serializable]
    public enum PriceableItemKinds
    {
        Usage = 10,
        AggregateCharge = 15,
        Recurring = 20,
        UnitDependentRecurring = 25,
        NonRecurring = 30,
        Discount = 40
    }
    ...
    public abstract class BasePriceableItemInstance : BaseObject
    {
        #region ID
    ...
    public bool IsLocalizedDescriptionDirty
    {
      get { return isLocalizedDescriptionDirty; }
        ...
        [MTDataMember(Description = "This specifies the kind of the priceable item instance", Length = 40)]
    [DataMember(IsRequired = false, EmitDefaultValue = false)]
        ...
        #region PITemplate
    [DataMember(IsRequired = false, EmitDefaultValue = false)]
        private bool isPITemplateDirty = false;
        private PCIdentifier m_PITemplate;
        [MTDataMember(Description = "This is the identifier of the related priceable item template", Length = 40)]
        [DataMember(IsRequired = false, EmitDefaultValue = false)]
        public PCIdentifier PITemplate
    {
        ...
        public bool IsPITemplateDirty
    {
        ...
        {
            return BaseObject.GetTypesFromAssemblyByAttribute(GENERATED_ASSEMBLY_NAME, typeof(MTPriceableItemInstanceAttribute));
    }
