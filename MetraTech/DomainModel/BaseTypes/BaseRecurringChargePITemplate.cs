...
namespace MetraTech.DomainModel.BaseTypes
{
    [DataContract]
    [Serializable]
    public abstract class BaseRecurringChargePITemplate : BasePriceableItemTemplate
    {
        #region Cycle
    ...
    [MTDataMember(Description = "This flag indicates whether the recurring charge should be prorated when the subscription is created with a definite endpoint.", Length = 40)]
    [DataMember(IsRequired = false, EmitDefaultValue = false)]
