...
namespace MetraTech.Metering.DatabaseMetering
{
    ...
    public class TimeZoneInformation
    {
      ...
      /// <summary>
      /// Get a TimeZoneInformation for a supplied name.
      /// </summary>
      /// <param name="name">The time zone to find.</param>
      /// <returns>The corresponding TimeZoneInformation.</returns>
      /// <exception cref="System.ArgumentOutOfRangeException">Thrown if the name is not found.</exception>
      ...
      /// <param name="utc">The time to convert.</param>
      /// <returns>The converted time.</returns>
      /// <exception cref="ArgumentOutOfRangeException">Thrown if the name is not found.</exception>
      public static DateTime FromUniversalTime( string name, DateTime utc )
      {
        TimeZoneInformation tzi = FromName( name );
        ...
        {
          // Uncomment the following to see the performance degradation caused due
          // to registry access. 
          // This is being done in the existing CovertTimeZone class.

//          using(RegistryKey objTimeZoneReg = objLocalRegistry.OpenSubKey( SKEY_NT + @"\" + Name ))
//          {
...
//          }
      ...
      /// </summary>
      /// <param name="name">The time zone index.</param>
      /// <param name="local">The time to convert.</param>
      /// <returns>The converted time.</returns>
      /// <exception cref="ArgumentOutOfRangeException">Thrown if the name is not found.</exception>
      /// <exception cref="NotSupportedException">Thrown if the method failed due to missing platform support.</exception>
      public static DateTime ToUniversalTime( string name, DateTime local )
      {
        TimeZoneInformation tzi = FromName( name );
        ...
        RegistryKey objLocalRegistry = Registry.LocalMachine;
