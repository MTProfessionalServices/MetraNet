...
namespace Metanga.Domain.Test
{
  ...
  public class ExpressionTest
  {
    ...
    */
    ...
    {
      var filterExpression = BuildBinaryExpression("Currency", BinaryOperator.Equal, "USD");
      var serializedExpression = ExpressionSerializer.Serialize(filterExpression);
    ...
    {
      var amountExpression = new BinaryExpression { Left = new ConstantExpression { Value = true }, Operator = BinaryOperator.Equal, Right = new ConstantExpression { Value = true} };
      var serializedExpression = ExpressionSerializer.Serialize(amountExpression);
      var deserializedExpression = ExpressionSerializer.Deserialize(serializedExpression);
