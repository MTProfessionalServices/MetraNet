...
public partial class ExpressionLanguageBaseVisitor<Result> : AbstractParseTreeVisitor<Result>, IExpressionLanguageVisitor<Result> {
	public virtual Result VisitOrExpression(ExpressionLanguageParser.OrExpressionContext context) { return VisitChildren(context); }

	public virtual Result VisitAndExpression(ExpressionLanguageParser.AndExpressionContext context) { return VisitChildren(context); }
	...
	public virtual Result VisitNotExpression(ExpressionLanguageParser.NotExpressionContext context) { return VisitChildren(context); }
