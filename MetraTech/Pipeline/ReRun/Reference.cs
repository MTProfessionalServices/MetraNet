...
namespace MetraTech.Pipeline.ReRun {
    ...
    public class Service : System.Web.Services.Protocols.SoapHttpClientProtocol {
        ...
        /// <remarks/>
        public Service() {
            this.Url = "http://localhost/BillingReRun/Service.asmx";
        }
		...
		/// <remarks/>
		[System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://metratech.com/webservices/GetTableName", RequestNamespace="http://metratech.com/webservices/", ResponseNamespace="http://metratech.com/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
		public string GetTableName(int rerunID) 
		{
			object[] results = this.Invoke("GetTableName", new object[] {rerunID});
        ...
        /// <remarks/>
        [System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://metratech.com/webservices/BeginIdentifyAnalyzeAndResubmit", RequestNamespace="http://metratech.com/webservices/", ResponseNamespace="http://metratech.com/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
        public void BeginIdentifyAnalyzeAndResubmit(int rerunID, string transactionID, string serializedFilter, string comment, string serializedContext) {
            this.Invoke("BeginIdentifyAnalyzeAndResubmit", new object[] {
                        rerunID,
                        transactionID,
                        serializedFilter,
                        comment,
        ...
        /// <remarks/>
        public System.IAsyncResult BeginBeginIdentifyAnalyzeAndResubmit(int rerunID, string transactionID, string serializedFilter, string comment, string serializedContext, System.AsyncCallback callback, object asyncState) {
            return this.BeginInvoke("BeginIdentifyAnalyzeAndResubmit", new object[] {
                        rerunID,
                        transactionID,
                        serializedFilter,
                        comment,
        ...
        /// <remarks/>
        public void EndBeginIdentifyAnalyzeAndResubmit(System.IAsyncResult asyncResult) {
            this.EndInvoke(asyncResult);
        }
 
		
		/// <remarks/>
		[System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://metratech.com/webservices/BeginIdentifyAnalyzeAndDelete", RequestNamespace="http://metratech.com/webservices/", ResponseNamespace="http://metratech.com/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
		public void BeginIdentifyAnalyzeAndDelete(int rerunID, string transactionID, string serializedFilter, string comment, string serializedContext) 
		{
			this.Invoke("BeginIdentifyAnalyzeAndDelete", new object[] {
																			rerunID,
																			transactionID,
																			serializedFilter,
																			comment,
		...
		/// <remarks/>
		public System.IAsyncResult BeginBeginIdentifyAnalyzeAndDelete(int rerunID, string transactionID, string serializedFilter, string comment, string serializedContext, System.AsyncCallback callback, object asyncState) 
		{
			return this.BeginInvoke("BeginIdentifyAnalyzeAndDelete", new object[] {
																						rerunID,
																						transactionID,
																						serializedFilter,
																						comment,
		...
		/// <remarks/>
		public void EndBeginIdentifyAnalyzeAndDelete(System.IAsyncResult asyncResult) 
		{
			this.EndInvoke(asyncResult);
		}
		...
		/// <Additions for 4.0/>
		[System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://metratech.com/webservices/BeginBackoutDelete", RequestNamespace="http://metratech.com/webservices/", ResponseNamespace="http://metratech.com/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
		public void BeginBackoutDelete(int rerunID, string transactionID, string comment, string serializedContext) 
		{
			this.Invoke("BeginBackoutDelete", new object[] {
														 rerunID,
														 transactionID,
														 comment,
														 serializedContext});
		...
		/// <remarks/>
		public System.IAsyncResult BeginBeginBackoutDelete(int rerunID, string transactionID, string comment, string serializedContext, System.AsyncCallback callback, object asyncState) 
		{
			return this.BeginInvoke("BeginBackoutDelete", new object[] {
																	 rerunID,
																	 transactionID,
																	 comment,
																	 serializedContext}, callback, asyncState);
		...
		/// <remarks/>
		public void EndBeginBackoutDelete(System.IAsyncResult asyncResult) 
		{
			this.EndInvoke(asyncResult);
		}
		...
		/// <remarks/>
		[System.Web.Services.Protocols.SoapDocumentMethodAttribute("http://metratech.com/webservices/BeginBackoutResubmit", RequestNamespace="http://metratech.com/webservices/", ResponseNamespace="http://metratech.com/webservices/", Use=System.Web.Services.Description.SoapBindingUse.Literal, ParameterStyle=System.Web.Services.Protocols.SoapParameterStyle.Wrapped)]
		public void BeginBackoutResubmit(int rerunID, string transactionID, string comment, string serializedContext) 
		{
			this.Invoke("BeginBackoutResubmit", new object[] {
														 rerunID,
														 transactionID,
														 comment,
														 serializedContext});
		...
		/// <remarks/>
		public System.IAsyncResult BeginBeginBackoutResubmit(int rerunID, string transactionID, string comment, string serializedContext, System.AsyncCallback callback, object asyncState) 
		{
			return this.BeginInvoke("BeginBackoutResubmit", new object[] {
																	 rerunID,
																	 transactionID,
																	 comment,
																	 serializedContext}, callback, asyncState);
		...
		/// <remarks/>
		public void EndBeginBackoutResubmit(System.IAsyncResult asyncResult) 
		{
			this.EndInvoke(asyncResult);
		}
       
		// end additions for 4.0
