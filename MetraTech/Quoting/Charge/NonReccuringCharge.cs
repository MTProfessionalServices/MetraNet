...
namespace MetraTech.Quoting.Charge
{
    ...
    {
        public NonReccuringCharge(QuotingConfiguration configuration, IChargeMetering metering, ILogger log)
        ...
        public override ChargeData Add(IMTServicedConnection transacConnection, QuoteRequest quoteRequest)
        {
            ...
            {
                Log.LogDebug("Preparing Non-Recurring Subscription Start Charges");
                ...
                Metering.MeterRecodrs(nonReccuringCharge);

                Log.LogDebug("Done Preparing Non-Recurring Subscription Start Charges");
            }
