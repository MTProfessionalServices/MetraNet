  ...
  public class QuotingForGroupSubsFunctionalTests
  {
    ...
    public void QuotingGroupSbsCorpAccount_diffBillingCycle(string billcycle)
    {
     ...
     /* testRunUniqueIdentifier = MetraTime.NowWithMilliSec; 
      ...
      request.Accounts.Add(Hierarchy[0]._AccountID.Value);
      request.Accounts.Add(Hierarchy[1]._AccountID.Value);
      request.Accounts.Add(Hierarchy[2]._AccountID.Value);
      request.Accounts.Add(Hierarchy[3]._AccountID.Value);
      ...
      request.SubscriptionParameters.CorporateAccountId = Hierarchy[0]._AccountID.Value;
