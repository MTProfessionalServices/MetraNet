...
namespace MetraTech.Shared.Test
{
  ...
  public class SharedTestCode
  {
    ...
    public static Dictionary<string, List<UDRCInstanceValueBase>> GetUDRCInstanceValuesSetToMiddleValues(IMTProductOffering productOffering, int? idUDRC = null)
    {
      ...
      MetraTech.Interop.MTProductCatalog.IMTCollection possibleInstances = productOffering.GetPriceableItems();
  ...
  public class ProductOfferingFactoryConfiguration
  {
    ...
    public ProductOfferingFactoryConfiguration(string BaseName, string Uniquifier)
    {
      SetDefaults();
      this.Name = BaseName;
      this.UniqueIdentifier = Uniquifier;
    }
  ...
  public class ProductOfferingFactory
  {
    ...
    private List<IMTRecurringCharge> piTemplate_FRRC_ChargePerSubList;
    ...
    public static IMTProductOffering Create(ProductOfferingFactoryConfiguration configuration)
    {
      ...
      for (int i = 0; i < configuration.CountNRCs; i++)
      {
        ...
        productOfferingHolder.CreateRateScheduleWithRulesFromFile("metratech.com/nonrecurringcharge",
                                                                  ...
                                                                  productOfferingHolder
                                                                      .piTemplate_NRC_ChargeOnSubscribeList[i].ID,
                                                                  string.Format(
      ...
      for (int i = 0; i < configuration.CountPairRCs; i++)
      {
      ...
      for (int i = 0; i < configuration.CountPairUDRCs; i++)
      {
        productOfferingHolder.CreateRateScheduleWithRulesFromFile("metratech.com/udrctapered",
                                                                  productOfferingHolder.mProductOffering
                                                                                       .NonSharedPriceListID,
                                                                  productOfferingHolder
                                                                    .piTemplate_UDRC_ChargePerParticipantList[i].ID,
                                                                  string.Format(
                                                                    "{0}\\Development\\Core\\MTProductCatalog\\{1}",
                                                                    Environment.GetEnvironmentVariable(
                                                                      "METRATECHTESTDATABASE"),
    ...
    public IMTRateSchedule CreateRateScheduleWithRulesFromFile(string paramTableName, int idPriceList, int idPITemplate, string xmlRuleSetFilePath)
    {
      ...
      //IMTParamTableDefinition pt = mProductCatalog.GetParamTableDefinitionByName(paramTableName);
                                                              ...
                                                              Int16 countNRCs)
    {
      IMTPriceableItemType priceableItemTypeNRC =
          mProductCatalog.GetPriceableItemTypeByName("Flat Rate Non Recurring Charge");
    ...
    private List<IMTRecurringCharge> CreateFlatRateRecurringCharge(bool chargePerParticipant, short countRCs)
    {
      ...
      for (int i = 0; i < countRCs; i++)
      {
        string name = chargePerParticipant ? "FRRC_CPP" : "FRRC_CPS";
        ...
        ((MetraTech.Localization.LocalizedEntity)piTemplate_FRRC.DisplayNames).SetMapping("DE", "{DE} " + piTemplate_FRRC.DisplayName);
    ...
    private List<IMTRecurringCharge> CreateUDRC(bool chargePerParticipant, short countUDRCs)
    {
      ...
      for (short i = 0; i < countUDRCs; i++)
      {
        ...
        {
          name = string.Format("UDRC_CPP_{0}_{1}", ChargeCounter, UniqueInstanceIdentifier, i);
        }
        else
        {
          name = string.Format("UDRC_CPS_{0}_{1}", ChargeCounter, UniqueInstanceIdentifier, i);
        }
        ...
        ((MetraTech.Localization.LocalizedEntity) piTemplate_UDRC.DisplayNames).SetMapping("DE",
                                                                                           "{DE} " +
                                                                                           piTemplate_UDRC.DisplayName);
