...
{
    internal sealed class DefaultHtmlEncoderEngine : EncoderEngineBase
    {
		public DefaultHtmlEncoderEngine()
            : base(EncoderEngineCategory.Html)
		{}
        ...
        protected override ApiOutput ExecuteInternal(ApiInput input)
        {
            ...
            return new ApiOutput(Microsoft.Security.Application.Encoder.HtmlEncode(input.ToString()));
        }
    }
}
