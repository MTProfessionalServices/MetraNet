...
{
    internal sealed class DefaultJavaScriptEncoderEngine : EncoderEngineBase
    {
		public DefaultJavaScriptEncoderEngine()
            : base(EncoderEngineCategory.JavaScript)
		{}
        ...
        protected override ApiOutput ExecuteInternal(ApiInput input)
        {
            ...
            return new ApiOutput(StringHelper.DequotString(Microsoft.Security.Application.Encoder.JavaScriptEncode(input.ToString()), "'"));
        }
    }
}
