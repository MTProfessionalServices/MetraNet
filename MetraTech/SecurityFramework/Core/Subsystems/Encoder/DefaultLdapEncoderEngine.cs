...
{
    internal sealed class DefaultLdapEncoderEngine : EncoderEngineBase
    {
		public DefaultLdapEncoderEngine()
            : base(EncoderEngineCategory.Ldap)
		{}
        ...
        protected override ApiOutput ExecuteInternal(ApiInput input)
        {
            ...
            return new ApiOutput(Microsoft.Security.Application.Encoder.LdapFilterEncode(input.ToString()));
        }
    }
}
