...
{
    internal sealed class DefaultVbScriptEncoderEngine : EncoderEngineBase
    {
		public DefaultVbScriptEncoderEngine()
            : base(EncoderEngineCategory.VbScript)
		{}
        ...
        protected override ApiOutput ExecuteInternal(ApiInput input)
        {
            ...
            return new ApiOutput(Microsoft.Security.Application.Encoder.VisualBasicScriptEncode(input.ToString()));
        }
    }
}
