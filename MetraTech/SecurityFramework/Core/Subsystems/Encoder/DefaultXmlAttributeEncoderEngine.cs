...
{
    internal sealed class DefaultXmlAttributeEncoderEngine : EncoderEngineBase
    {
        public DefaultXmlAttributeEncoderEngine()
            : base(EncoderEngineCategory.XmlAttribute)
		{}
        ...
        protected override ApiOutput ExecuteInternal(ApiInput input)
        {
            ...
            return new ApiOutput(Microsoft.Security.Application.Encoder.XmlAttributeEncode(input.ToString()));
        }
    }
}
