...
{
    internal sealed class DefaultXmlEncoderEngine : EncoderEngineBase
    {
		public DefaultXmlEncoderEngine()
            : base(EncoderEngineCategory.Xml)
		{}
        ...
        protected override ApiOutput ExecuteInternal(ApiInput input)
        {
            ...
            return new ApiOutput(Microsoft.Security.Application.Encoder.XmlEncode(input.ToString()));
        }
    }
}
