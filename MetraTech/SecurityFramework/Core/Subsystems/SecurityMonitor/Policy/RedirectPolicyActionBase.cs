...
{
    /// <summary>
    /// Provides a base class for redirect policy action definitions.
    /// </summary>
    public class RedirectPolicyActionBase : PolicyAction
    {
        /// <summary>
        /// Gets or sets a destination path to redirect.
		/// </summary>
        ...
        protected RedirectPolicyActionBase(SecurityPolicyActionType actionType)
            : base(actionType)
        {
        }
		...
		public override void Record(SecurityEventWriter writer)
		{
			...
			writer.Write(Constants.Properties.DestinationPath, DestinationPath);
		}
    }
}
