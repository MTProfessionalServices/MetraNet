...
{
	public class WebInspectorResponseEngine : WebInspectorEngineBase
	{
		public WebInspectorResponseEngine()
			: base(WebInspectorEngineCategory.WebInspectorResponse)
		{ }

		protected override ApiOutput ExecuteInternal(ApiInput input)
		{
			ApiOutput result = base.ExecuteInternal(input);
			WebInspectorResponseApiInput apiInput = input.Value as WebInspectorResponseApiInput;
			...
			Inspector.ProcessResponse(apiInput.App, apiInput.Request, apiInput.Response);
