...
{
	public class WebInspectorErrorApiInput
	{
		...
		public WebInspectorErrorApiInput(HttpApplication app, HttpResponse response, Exception exception, Exception baseException)
		{
			App = app;
			Response = response;
