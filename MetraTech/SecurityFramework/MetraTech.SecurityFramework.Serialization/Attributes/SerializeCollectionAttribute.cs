...
{
	/// <summary>
	/// Implementing declarative restriction for serialize properties if property type is collection
	/// </summary>
	public class SerializeCollectionAttribute : SerializeAttribute
	{
		/// <summary>
