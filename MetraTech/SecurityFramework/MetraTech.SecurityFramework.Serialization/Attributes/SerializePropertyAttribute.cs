...
{
	/// <summary>
	/// Implementing declarative restriction for serialize properties if property type is not collection
	/// </summary>
	public class SerializePropertyAttribute : SerializeAttribute
	{
		/// <summary>
		/// Gets or sets default type of property in xml document
		/// </summary>
