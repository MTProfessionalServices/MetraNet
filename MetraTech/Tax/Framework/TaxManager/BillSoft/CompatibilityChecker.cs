...
namespace MetraTech.Tax.Framework.MtBillSoft
{
  public class CompatibilityChecker
  {
    ...
    private PeHeaderReader mReader;

    public CompatibilityChecker(string path, string dllFileNm)
    {
      Initialize(path + @"\" + dllFileNm);
    }

    public CompatibilityChecker(string dllPathAndName)
    {
      Initialize(dllPathAndName);
    }
    ...
    private void Initialize(string filename)
    {
      mFileName = filename;
      CheckName();
      mReader = new PeHeaderReader(mFileName);
      mSpan = DateTime.Now - LinkDate;
    }
    ...
    private void CheckName()
    {
      ...
      if (!File.Exists(mFileName))
        throw new FileNotFoundException("File (" + mFileName + ") does not seem to exist. Is the installation missing?");
    }

    public DateTime LinkDate
    {
      get { return mReader.TimeStamp; }
    }
    ...
    public Boolean IsOutOfDate
    {
      get
      {
        return (mSpan.TotalDays > 31); // Largest number of day a month can have...
        // TODO: ? return mSpan.TotalDays > DateTime.DaysInMonth(mDllLinkDate.Year, mDllLinkDate.Month);
      }
    }

    public Boolean Is32Bit
    {
      get { return mReader.Is32BitHeader; }
    }
    public Boolean Is64Bit
    {
      get { return !Is32Bit; }
    }
    public Boolean AreBinariesCompatible
    {
      get { return Is32Bit == PeHeaderReader.GetCallingAssemblyHeader().Is32BitHeader; }
    }
    public double DaysSinceCreation()
    {
      return mSpan.TotalDays;
    }


#pragma warning disable 649
    // This code is courtesy of John Stewien, http://code.cheesydesign.com/?p=572
...
#pragma warning restore 649
      ...
      {
        var pathCallingAssembly = System.Reflection.Assembly.GetCallingAssembly().Location;
