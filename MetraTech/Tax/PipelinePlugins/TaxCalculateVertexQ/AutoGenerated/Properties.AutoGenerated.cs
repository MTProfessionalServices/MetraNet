...
namespace MetraTech.Tax.Plugins.AutoGenerated
{
            ...
            if (xmlConfig.DocumentElement != null)
            {
                ...
                if (generalConfigProps == null)
                {
                    throw new ConfigurationErrorsException(
                        String.Format("The '{0}' was not found in t xpath = {1}. Can not configure Plug-in. Configuration content = '{2}'"
    ...
    public sealed class PipelineProperties
    {
        ...
        private PipelineProperties(PlugInBase.LogDelegate log, IMTSystemContext systemContext, XmlDocument xmlConfig)
        {
            ...
            _terminationLocation = new Binding<string>(nameId.GetNameID(GetValueFromParameter(pipelineProps, "TerminationLocation")));
        ...
        private static readonly Dictionary<Type, Func<ISession, int, object>> TypeMappingGet = new Dictionary<Type, Func<ISession, int, object>>
            {
...
#pragma warning restore 0168
        ...
        private static readonly Dictionary<Type, Action<ISession, int, object>> TypeMappingSet = new Dictionary<Type, Action<ISession, int, object>>
            {
        ...
        {
            var isString = Nullable.GetUnderlyingType(typeof(T)) != null;
            var hasValue = isString ? property == null : property.HasValue;
            if (!hasValue)
            {
                var message = _log(PlugInBase.LogLevel.Error, "Cannot set pipeline values to null");
                throw new InvalidValueException(message);
            }
            if (property != null && property.Id > -1)
