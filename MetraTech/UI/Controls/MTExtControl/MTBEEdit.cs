...
namespace MetraTech.UI.Controls
{
  ...
  [ToolboxData("<{0}:MTBEEdit runat=server></{0}:MTBEEdit>")]
  public class MTBEEdit : WebControl 
  {
    #region JavaScript
    #endregion
    ...
    protected override void RenderContents(HtmlTextWriter output)
    {
      ...
      string html = @"<a href=""{0}BEEdit.aspx?Name={1}&Extension={2}&ParentId={3}&ParentName={4}&Association={5}""><img border=""0"" src=""/Res/Images/Icons/grid.png"" />&nbsp;{6}</a>";
