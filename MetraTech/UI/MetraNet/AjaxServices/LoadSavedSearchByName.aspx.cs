...
public partial class AjaxServices_LoadSavedSearchByName : MTPage
{
  protected void Page_Load(object sender, EventArgs e)
  {
    string searchName = Request["SavedSearchName"];
    ...
    items.Filters.Add(new MTFilterElement("Name", MTFilterElement.OperationType.Equal, searchName));
    items.Filters.Add(new MTFilterElement("Description", MTFilterElement.OperationType.Equal, Session.SessionID));
