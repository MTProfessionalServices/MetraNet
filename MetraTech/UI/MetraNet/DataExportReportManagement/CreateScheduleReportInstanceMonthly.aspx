<%@ Page Title="Create Monthly Report Schedule" Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" CodeFile="CreateScheduleReportInstanceMonthly.aspx.cs" Inherits="DataExportReportManagement_CreateScheduleReportInstanceMonthly" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
 <script src="JavaScript/DataExport.js" type="text/javascript"></script>
  ...
  <!-- Title Bar -->
  <MT:MTTitle ID="MTTitle1" Text="Create Monthly Report Schedule" runat="server" meta:resourcekey="MTTitle1Resource1" /><br />
