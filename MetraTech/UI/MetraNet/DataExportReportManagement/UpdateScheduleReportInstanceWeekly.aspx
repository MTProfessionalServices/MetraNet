<%@ Page Title="Update Weekly Report Schedule" Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" CodeFile="UpdateScheduleReportInstanceWeekly.aspx.cs" Inherits="DataExportReportManagement_UpdateScheduleReportInstanceWeekly" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <!-- Title Bar -->
  <MT:MTTitle ID="MTTitle1" Text="Update Weekly Report Schedule" runat="server" meta:resourcekey="MTTitle1Resource1" /><br />
