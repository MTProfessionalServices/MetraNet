<%@ Page Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" Inherits="GroupSubscriptions_SetFlatRateRCAccount"
  Title="<%$Resources:Resource,TEXT_TITLE%>" Culture="auto" UICulture="auto" CodeFile="SetFlatRateRCAccount.aspx.cs" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
  <div class="CaptionBar">
    <asp:Label ID="lblSetFRRCAccountTitle" runat="server" Text="Flat Rate Recurring Charge Account Configuration"
      meta:resourcekey="lblSetFRRCAccountTitle"></asp:Label>
  </div>
  <br />
  ...
  <MT:MTDataBinder ID="MTDataBinder1" runat="server">
    <DataBindingItems>
      <MT:MTDataBindingItem ID="MTDataBindingItem1" runat="server" ControlId="lblErrorMessage"
