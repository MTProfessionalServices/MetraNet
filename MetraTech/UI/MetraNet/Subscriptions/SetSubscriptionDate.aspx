...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <div class="LeftColumn">
      ...
      <br />
      <MT:MTDatePicker ID="StartDate" runat="server" Label="Start Date" AllowBlank="False" ControlHeight="18" ControlWidth="120" HideLabel="False" LabelWidth="120" Listeners="{}" meta:resourcekey="StartDateResource1" OptionalExtConfig="format:DATE_FORMAT,&#13;&#10;                             altFormats:DATE_TIME_FORMAT" ReadOnly="False" TabIndex="0" XType="DateField" LabelSeparator=":" XTypeNameSpace="form" />
      ...
      <br />
      <MT:MTDatePicker ID="EndDate" runat="server" Label="End Date" AllowBlank="true" ControlHeight="18" ControlWidth="120" HideLabel="False" LabelWidth="120" Listeners="{}" meta:resourcekey="EndDateResource1" OptionalExtConfig="format:DATE_FORMAT,&#13;&#10;                             altFormats:DATE_TIME_FORMAT" ReadOnly="False" TabIndex="0" XType="DateField" LabelSeparator=":" XTypeNameSpace="form" />
    ...
    <center>   
      <table cellspacing="0">
        <tr>
          ...
          <td  class="x-panel-btn-td">
            <MT:MTButton ID="btnCancel" OnClientClick="return checkButtonClickCount();" Width="50px" runat="server" Text="<%$Resources:Resource,TEXT_CANCEL%>" CausesValidation="False" TabIndex="501" OnClick="btnCancel_Click" />
          </td>
        </tr>
      </table>
       </center>     
