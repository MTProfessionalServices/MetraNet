...
Ext.ux.StringRangeField = Ext.extend(Ext.form.Field, {
  defaultAutoCreate: { tag: 'input', type: 'hidden' }
    ...
    , initComponent: function() {
      Ext.ux.StringRangeField.superclass.initComponent.call(this);
      ...
      this.start_value_ctl = new Ext.form.TextField(startValueConfig);
      ...
      this.end_value_ctl = new Ext.form.TextField(endValueConfig);
    ...
    , onRender: function(ct, position) {
      ...
      Ext.ux.StringRangeField.superclass.onRender.call(this, ct, position);
...
Ext.reg('stringrange', Ext.ux.StringRangeField);