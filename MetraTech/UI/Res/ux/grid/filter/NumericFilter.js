Ext.ux.grid.filter.NumericFilter = Ext.extend(Ext.ux.grid.filter.Filter, {
	...
	isActivatable: function(){
		...
		return value.eq !== undefined || value.gt !== undefined || value.gte !== undefined ||value.lt !== undefined || value.lte !== undefined || value.ne !== undefined;
	},
	...
	validateRecord: function(record){
		...
		if(values.lte != undefined && val >= values.lte)
			return false;
		
		if(values.gt != undefined && val < values.gt)
			return false;
			
		if(values.gte != undefined && val <= values.gte)
			return false;			
