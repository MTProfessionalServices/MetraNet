...
{
    public class AMGetUsageDetailsIntervalFirst20 : AppMethodBase, AppMethodI
    {
        Statistic statistic;
        UsageHistoryServiceClient client = null;
        private static readonly ILog log = LogManager.GetLogger(typeof(AMGetUsageDetailsIntervalFirst20));

        public AMGetUsageDetailsIntervalFirst20()
        {
            group = "usage";
            name = "getUsageDetailsIntervalFirst20";
            fullName = "Get Usage Details IntervalFirst20";
