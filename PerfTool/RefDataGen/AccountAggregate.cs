...
namespace AppRefData
{
    ...
    {
        static FakeSecurity.FakeSecurity fakeSecurity;
        ...
        {
            fakeSecurity = new FakeSecurity.FakeSecurity("mtkey");
        }
        ...
        private void initContactView()
        {
            ...
            contact.c_ContactType = FastEnums.eContactType.None;
        ...
        private void addUserToAccount()
        {
            ...
            userCredentials.tx_password = fakeSecurity.HashNewPassword("123", nm_login, nm_space);
        ...
        public void addCapabilityManageAccountHierarchy()
        {
            ...
            ci.id_cap_type = 1; // Don't know why but...
        ...
        public string getValueForPathCapability()
        {
            ...
            return String.Format("{0}/{1}/", oldest.tx_path, id_acc);
        }
        ...
        public void buildAvInternal()
        {
            ...
            avInternal.c_InvoiceMethod = FastEnums.eInvoiceMethod.Standard;
            avInternal.c_UsageCycleType = FastEnums.eUsageCycleType.Monthly;
            avInternal.c_Language = 277; //FIXME
            avInternal.c_StatusReason = 661;
