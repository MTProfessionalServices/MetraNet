...
BOOL PipelineTMinCounter::Init()
{
	const char * functionName = "PipelineTMinCounter::Collect";
	...
	mTMin = pipelineInfo.GetThresholdMin();

	return TRUE;
}

BOOL PipelineTMinCounter::Collect(DWORD & arValue)
{
	const char * functionName = "PipelineTMinCounter::Collect";
...
BOOL PipelineTMinBaseCounter::Collect(DWORD & arValue)
{
