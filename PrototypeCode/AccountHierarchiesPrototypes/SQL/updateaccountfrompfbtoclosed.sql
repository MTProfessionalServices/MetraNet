     ...
     BEGIN
      ...
      BEGIN
       ...
       -- join between t_acc_usage_interval and t_usage_interval
        inner JOIN t_acc_usage_interval aui ON ui.id_interval = aui.id_usage_interval
      
        -- join between t_account_state and t_acc_usage_interval
        inner JOIN t_account_state astate ON aui.id_acc = astate.id_acc 
      WHERE
       ...
       BEGIN      
        ...
        UpdateAccountState(cursor_id_acc,'CL');
        end loop;    
        close cursorvar;
       END;
      END;
