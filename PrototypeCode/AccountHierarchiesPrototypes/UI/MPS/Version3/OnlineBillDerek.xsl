...
<!--      <td align="right" bgcolor="#000099"><font face="Arial" color="white" size="1"><b>Incurred Charges</b></font></td> -->
    ...
    <tr>
      <td colspan="2"><font face="Arial" color="navy" size="1">No charges found for the period from 11/1/2001 through Today.</font></td>
    </tr>
  <!-- Apply templates for the charges -->
    <xsl:apply-templates select="bubba">
      <xsl:sort select="display" />
    </xsl:apply-templates>
    
    <xsl:apply-templates select="tacos">
      <xsl:sort select="display" />
    </xsl:apply-templates>
  <!-- End Templates -->
  </table>
    ...
    <td align="left">
      ...
      <nobr>
        <font face="Arial" size="1" color="navy">
          <a href="detail.htm"><img border="0" src="/samplesite/us/images/icons/genericProduct.gif" /><xsl:value-of select="display" /></a>
        </font>
      </nobr>
    </td>
