<%
  ...
  Function RenderPage(strType)
    ...
    if UCase(mstrDisplayType) = "MYCHARGES" then
      Call objXSL.Load(server.MapPath("/prototypes/UI/MPS/Version3/MyCharges.xsl"))
      Call objXML.Load(server.MapPath("/prototypes/UI/MPS/Version3/Charges.xml"))
    else
      Call objXSL.Load(server.MapPath("/prototypes/UI/MPS/Version3/OnlineBill.xsl"))
      Call objXML.Load(server.MapPath("/prototypes/UI/MPS/Version3/Charges.xml"))
    end if
...
%>
    ...
    <br><br><br>
    <b>Notes:</b><br>
    This view represents the bill as seen by Herb, VP of Engineering.  Accounts in the Engineering sub-hierarchy redirect charges to Herb.
