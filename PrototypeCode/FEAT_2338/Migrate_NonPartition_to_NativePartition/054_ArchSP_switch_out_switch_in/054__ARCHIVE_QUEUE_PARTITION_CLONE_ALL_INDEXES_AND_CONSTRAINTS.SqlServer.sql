IF OBJECT_ID('archive_queue_partition_clone_all_indexes_and_constraints') IS NOT NULL 
	DROP PROCEDURE archive_queue_partition_clone_all_indexes_and_constraints
GO

CREATE PROCEDURE archive_queue_partition_clone_all_indexes_and_constraints
