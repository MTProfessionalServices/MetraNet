...
from t_vw_base_props
	INNER JOIN t_po on id_prop = t_po.id_po
  ...
  (
    select id_po from t_acc_template_subs_pub where id_acc_template = %%ACC_TEMPLATE%% and id_group is null
  )
