                    ...
                    WHERE   tsch.id_rep_instance_id = %%ID_REP_INSTANCE%% AND LOWER(tsch.c_sch_type) = N'daily'
                    UNION 
                    SELECT 
						tsch.id_rp_schedule, 
						tsch.c_sch_type, 
                    ...
                    WHERE   tsch.id_rep_instance_id = %%ID_REP_INSTANCE%%  AND  LOWER(tsch.c_sch_type) = N'weekly'
                    UNION
                    SELECT 
						tsch.id_rp_schedule, 
						tsch.c_sch_type, 
                    ...
                    WHERE   tsch.id_rep_instance_id = %%ID_REP_INSTANCE%%  AND  LOWER(tsch.c_sch_type) = N'monthly'
