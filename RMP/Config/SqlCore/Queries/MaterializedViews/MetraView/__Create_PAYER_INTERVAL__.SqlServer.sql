	...
	CREATE CLUSTERED INDEX idx_payer_interval ON %%PAYER_INTERVAL%% (id_acc, id_usage_interval,id_view, id_dm_acc)
	CREATE NONCLUSTERED INDEX idx_se_payer_interval ON %%PAYER_INTERVAL%% (id_se)
