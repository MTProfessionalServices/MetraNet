...
Truncate table %%%NETMETERSTAGE_PREFIX%%%summ_delta_d_adj_usagedetail
...
update dm_1 set
      ...
      dm_1.PrebillAdjustmentID = (CASE WHEN tmp2.PrebillAdjustmentID != -1 THEN tmp2.PrebillAdjustmentID else dm_1.PrebillAdjustmentID END),
      ...
      dm_1.IsPrebillAdjusted = (CASE WHEN tmp2.IsPrebillAdjusted ='Y' or dm_1.IsPrebillAdjusted ='Y' THEN 'Y' else 'N' END),
