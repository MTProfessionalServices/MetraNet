...
from %%DELTA_DELETE_T_ACC_USAGE%% au1  left outer join T_PV_AUDIOCONFCONNECTION child1 
on au1.id_sess=child1.id_sess and au1.id_usage_interval=child1.id_usage_interval
left outer join %%DELTA_DELETE_T_PV_AUDIOCONFFEATURE%% child2  
...
/* ESR-2908 delete audiocall with the same predicate that was used to do previous update of audiocall */
