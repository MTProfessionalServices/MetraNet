	begin
			...
			update t_mv_payee_session 
				...
				from 
				(
				  select a.id_acc, a.id_dm_acc, b.id_usage_interval ,min(d.vt_start) vt_start, max(d.vt_end) vt_end, max(d.id_dm_acc) new_id_dm_acc 
				  from	( 
					/* the missing list of id_dm_acc from t_mv_payer_interval */ 
					select distinct b.id_acc, b.id_dm_acc 
