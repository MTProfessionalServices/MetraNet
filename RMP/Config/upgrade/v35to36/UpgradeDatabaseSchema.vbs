...
'*
'* These functions upgrade MetraTech Platform database from V3.5 to V3.6
'*
'******************************************************************************************
...
Const kDBState_DB_35_PRESENT		= "3.5"
...
Public Function Main() ' As Boolean
	...
	if (DBStatus = kDBState_DB_35_PRESENT) then
		' call the upgrade database function to upgrade from 3.5 to 3.6
		UpgradeDatabaseSQLFromV35
	else 
...
Function UpgradeDatabaseSQLFromV35
	...
	writelog("*** Upgrading Core Database from v3.5 ... ***")

	writelog("*** Update Database Schema...***")	
	strFilename = strInstallDir & SHAREDEXEC_PATH & "installutiltest.exe"
	strArguements = " -InstExtDbTables " & strInstallDir & "rmp\config\upgrade\v35to36 querytags.xml"
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\v35to36\Procedure.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v35to36\Procedure.txt"
