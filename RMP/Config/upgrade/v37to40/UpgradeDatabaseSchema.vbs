...
'*
'* These functions upgrade MetraTech Platform database from V3.7 to V4.0
'*
'******************************************************************************************
...
Const kDBState_DB_37_PRESENT		= "3.7"
...
Public Function Main() ' As Boolean
	...
	if (DBStatus = kDBState_DB_37_PRESENT) then
		' call the upgrade database function to upgrade from 3.7 to 4.0
		UpgradeDatabaseSQLFromV37
	else 
...
Function UpgradeDatabaseSQLFromV37
	...
	writelog("*** Upgrading Core Database from v3.7 ... ***")

	writelog("*** Update Database Schema...***")	
	strInFile = strInstallDir & "RMP\Config\Upgrade\v37to40\v37to40.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v37to40\v37to40.txt"
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\v37to40\Procedure.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v37to40\Procedure.txt"
	strFilename = "osql.exe"
	strArguements = " -l 3000 -S " & strDBHostName & " -d " & strDBName & " -U " & strAdminID & " -P " & """" & strAdminPwd & """" & " -i " & strInFile & " -o " & strOutFile
	intstatus = WshShell.Run(strfilename & strArguements,VBHide, true)
	...
	writelog("*** Upgraded Core Database from v3.7 to v4.0 successfully ... ***")
