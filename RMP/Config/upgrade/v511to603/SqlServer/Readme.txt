To upgrade the 5.1.1 database to 6.0.3
...
3) Run the hooks from ICE 
     ...
     Product Catalog and 
     Usage
4) Run DBUpgradeExec tool using Setup\MetraPay scripts folder
...
7) Run DBUpgradeExec tool using Cleanup\NetMeter scripts folder
...
Note: 
  ...
  DBUpgradeExec and CCHashGenerator tool should be in the bin folder as part of 6.0.3 installation.
