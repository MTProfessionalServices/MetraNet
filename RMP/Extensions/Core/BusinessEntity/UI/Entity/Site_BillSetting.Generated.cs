...
namespace Core.UI
{
  ...
  public partial class Site_BillSetting : MetraTech.BusinessEntity.DataAccess.Metadata.DataObject, global::Core.UI.Interface.ISite_BillSetting
  {
    
    public const string FullName = "Core.UI.Site_BillSetting";
    ...
    private global::Core.UI.Site_BillSettingBusinessKey _site_BillSettingBusinessKey = new Site_BillSettingBusinessKey();
    ...
    [System.Runtime.Serialization.DataMemberAttribute()]
    public virtual global::Core.UI.Site_BillSettingBusinessKey Site_BillSettingBusinessKey
    {
      get
      {
        return this._site_BillSettingBusinessKey;
      }
      set
      {
        this._site_BillSettingBusinessKey = value;
      }
    }
    ...
    public virtual void SetRelationshipItem(object item)
    {
      ...
      {
        if (item is global::Core.UI.Interface.IBillSetting)
        {
          BillSetting = item as global::Core.UI.Interface.IBillSetting;
        }
        else
        {
    ...
    {
      var _site_BillSetting = new global::Core.UI.Site_BillSetting();
      _site_BillSetting.Site_BillSettingBusinessKey = (global::Core.UI.Site_BillSettingBusinessKey)Site_BillSettingBusinessKey.Clone();
      return _site_BillSetting;
    }
    ...
    {
      var item = dataObject as global::Core.UI.Site_BillSetting;
      Site_BillSettingBusinessKey = item.Site_BillSettingBusinessKey;
    }
    
    public static new System.Type[] GetKnownTypes()
    {
      var knownTypes = new List<System.Type>();
      knownTypes.Add(typeof(global::Core.UI.Site_BillSettingBusinessKey));
  ...
  [System.Runtime.Serialization.DataContractAttribute(IsReference=true)]
  [System.SerializableAttribute()]
  public partial class Site_BillSettingBusinessKey : MetraTech.BusinessEntity.DataAccess.Metadata.BusinessKey, global::Core.UI.Interface.ISite_BillSettingBusinessKey
  {
    
    private string _entityFullName = "Core.UI.Site_BillSetting";
    ...
    public override string EntityFullName
    {
      ...
      set
      {
        this._entityFullName = "Core.UI.Site_BillSetting";
      }
    }
    ...
    {
      var _businessKey = new Site_BillSettingBusinessKey();
