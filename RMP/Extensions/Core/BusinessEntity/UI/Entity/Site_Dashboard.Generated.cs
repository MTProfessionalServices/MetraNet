...
namespace Core.UI
{
  ...
  public partial class Site_Dashboard : MetraTech.BusinessEntity.DataAccess.Metadata.DataObject, global::Core.UI.Interface.ISite_Dashboard
  {
    
    public const string FullName = "Core.UI.Site_Dashboard";
    ...
    private global::Core.UI.Site_DashboardBusinessKey _site_DashboardBusinessKey = new Site_DashboardBusinessKey();
    ...
    [System.Runtime.Serialization.DataMemberAttribute()]
    public virtual global::Core.UI.Site_DashboardBusinessKey Site_DashboardBusinessKey
    {
      get
      {
        return this._site_DashboardBusinessKey;
      }
      set
      {
        this._site_DashboardBusinessKey = value;
      }
    }
    ...
    {
      var _site_Dashboard = new global::Core.UI.Site_Dashboard();
      _site_Dashboard.Site_DashboardBusinessKey = (global::Core.UI.Site_DashboardBusinessKey)Site_DashboardBusinessKey.Clone();
    ...
    {
      var item = dataObject as global::Core.UI.Site_Dashboard;
      Site_DashboardBusinessKey = item.Site_DashboardBusinessKey;
    }
    
    public static new System.Type[] GetKnownTypes()
    {
      var knownTypes = new List<System.Type>();
      knownTypes.Add(typeof(global::Core.UI.Site_DashboardBusinessKey));
  ...
  [System.Runtime.Serialization.DataContractAttribute(IsReference=true)]
  [System.SerializableAttribute()]
  public partial class Site_DashboardBusinessKey : MetraTech.BusinessEntity.DataAccess.Metadata.BusinessKey, global::Core.UI.Interface.ISite_DashboardBusinessKey
  {
    
    private string _entityFullName = "Core.UI.Site_Dashboard";
    ...
    public override string EntityFullName
    {
      ...
      set
      {
        this._entityFullName = "Core.UI.Site_Dashboard";
      }
    }
    ...
    {
      var _businessKey = new Site_DashboardBusinessKey();
