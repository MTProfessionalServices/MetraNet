<%@ Page Language="C#" MasterPageFile="~/MasterPages/AdminPageExt.master" AutoEventWireup="true" Inherits="BEList"  Title="<%$Resources:Resource,TEXT_TITLE%>" CodeFile="BEList.aspx.cs"  Culture="auto" UICulture="auto"%>
...
<uc1:BreadCrumb ID="BreadCrumb1" runat="server" />
  ...
  //  });
       ...
       top.Ext.MessageBox.show({
               ...
               fn: function(btn){
                 if (btn == 'ok')
                 {
                    ...
                    Ext.Ajax.request({
                        url: '<%=Request.ApplicationPath%>/AjaxServices/BEDeleteSvc.aspx?ChildGrid=true',
                        params: parameters,
                        scope: this,
                        disableCaching: true,
                        ...
                        callback: function(options, success, response) {
                          if (success) {
                            if(response.responseText == "OK") {
                              ...
                              if (entityName == 'Core.UI.BillSetting') {
    ...
    function onCancel_<%= MyGrid1.ClientID %>()
    {
       ...
       {    
        document.location.href = "<%=Request.ApplicationPath%>/BE/BE.aspx";
       }
    }
