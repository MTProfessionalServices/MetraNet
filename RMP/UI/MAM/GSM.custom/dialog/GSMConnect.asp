...
'
' DIALOG	    :  GSMConnect.asp
' DESCRIPTION	:  Connect a GSMServiceAccount to another account
...
Form.ServiceMsixdefFileName = mam_GetServiceDefForOperation("Connect") 
...
PRIVATE FUNCTION Form_Initialize(EventArg) ' As Boolean
  ...
  If(Len(Request.QueryString("Parent"))) Then
    Service.Properties("ancestorAccountID") = Request.QueryString("Parent")
  End IF
...
FUNCTION OK_Click(EventArg) ' As Boolean
    ...
    Else
        ...
        ' Success
        Form.RouteTo = mam_ConfirmDialogEncodeAllURL(Session("MAM_DYNAMIC_TITLE") & " Successful" & "The account was updated successfully.", mam_GetDictionary("TEXT_ACCOUNT_ADDED_SUCCESSFULLY"), mam_GetDictionary("SUBSCRIBER_FOUND") & "?AccountID=" & Service.Properties("_AccountID"))
