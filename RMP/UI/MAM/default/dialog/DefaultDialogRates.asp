...
PUBLIC FUNCTION Form_DisplayEndOfPage(EventArg) ' As Boolean
    ...
    strEndOfPageHTMLCode = strEndOfPageHTMLCode & "<BR><CENTER><BUTTON Name='CANCEL' Class='clsOKButton' OnClick='mdm_RefreshDialog(this); removeExtraFrame(); return false;'>Back</BUTTON></center>"
