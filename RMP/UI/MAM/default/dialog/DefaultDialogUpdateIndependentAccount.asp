...
PRIVATE FUNCTION OK_Click(EventArg) ' As Boolean
    ...
    booOK = Service.Meter(True,objOutPutSession)
	  If(booOK)Then
        ...
        OK_Click                    =   TRUE
        strRouteTo                  =   mam_GetDictionary("SUMMARY_ACCOUNT_INFO_DIALOG")  
        Form.RouteTo                =   mam_ConfirmDialogEncodeAllURL(mam_GetDictionary("TEXT_UPDATE_ACCOUNT"), mam_GetDictionary("TEXT_INFO_SUCCEFULLY_UPDATED"), strRouteTo) & "&ReLoadAccount=TRUE"
...
PRIVATE FUNCTION RefreshPage_Click(EventArg) ' As Boolean
    ...
    Call response.redirect( mam_GetDictionary("SUBSCRIBER_FOUND") & "?AccountId=" & mam_GetSubscriberAccountID() & "&ForceLoad=TRUE" & "&RouteTo=" & mam_GetDictionary("UPDATE_INDEPENDENT_ACCOUNT_DIALOG"))
