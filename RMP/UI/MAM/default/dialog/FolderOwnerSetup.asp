...
PRIVATE FUNCTION Form_DisplayEndOfPage(EventArg) ' As Boolean
    ...
    strEndOfPageHTMLCode = strEndOfPageHTMLCode & "<button class='clsButtonLarge' name=""ADDFolder"" onclick=""window.location.href='" & mam_GetDictionary("FOLDER_OWNER_ADD_DIALOG") & "?MDMReload=TRUE'"">" & mam_GetDictionary("ADD_ACCOUNT_FOR_ADMINISTRATION") & "</button>&nbsp;&nbsp;&nbsp;"
