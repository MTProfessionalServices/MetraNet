...
Private Function Form_Initialize(Event_Arg)
  ...
  If IsValidObject(Session("SubscriberYAAC")) Then
    Form.RouteTo = mam_GetDictionaryDefault(Session("SubscriberYAAC").AccountType & "_UPDATE_DIALOG", mam_GetDictionary("GENERIC_UPDATE_DIALOG")) & "?AccountType=" & Session("SubscriberYAAC").AccountType
  End If
