...
session("CANCEL_ROUTETO") = mam_GetDictionary("OWNER_ACCOUNTS_DIALOG")
...
PRIVATE FUNCTION Form_LoadProductView(EventArg) ' As Boolean
  ...
  ProductView.Properties.Flags = eMSIX_PROPERTIES_FLAG_PRODUCTVIEW 
	...
	mdm_GetDictionary().add "OWNER_TITLE", mam_GetFieldIDFromAccountID(Session("SubscriberYAAC").AccountID)
  ...
  Set ProductView.Properties.RowSet = mgr.GetOwnerAccountsAsRowset(mam_GetHierarchyTime())
...
PUBLIC FUNCTION Form_DisplayCell(EventArg) ' As Boolean   
    ...
    Select Case Form.Grid.Col
         ...
         Case 1
            ...
            HTML_LINK_EDIT = HTML_LINK_EDIT  & "<A HRef='" & mam_GetDictionary("OWNER_UPDATE_DIALOG") & "?Update=TRUE&id=" &  ProductView.Properties("id_owner") 
...
'				  	strMsgBox = mam_GetDictionary("TEXT_WOULD_YOU_LIKE_TO_REMOVE") & " " & server.HTMLEncode(Trim(ProductView.Properties("hierarchyname"))) & " " & mam_GetDictionary("TEXT_FROM") & " " & Server.HTMLEncode(Session("SubscriberYAAC").AccountName) & "?" 
...
'		    		HTML_LINK_EDIT = HTML_LINK_EDIT & mam_GetDictionary("OWNER_DELETE_DIALOG") & "?id=" &  ProductView.Properties("id_owner")
...
'            Set objYAAC = FrameWork.AccountCatalog.GetAccount(CLng(ProductView.Properties("id_owner")), mam_GetSystemUserHierarchyTime())
						...
						HTML_LINK_EDIT = HTML_LINK_EDIT & mam_GetNameIDLink(Empty, ProductView.Properties("id_owner"), ProductView.Properties("hierarchyname"), Empty)' objYAAC.IsFolder)
						HTML_LINK_EDIT = HTML_LINK_EDIT  & "</td>"
...
PRIVATE FUNCTION Form_DisplayEndOfPage(EventArg) ' As Boolean
    ...
    ' ADD OWNER BUTTON
    strEndOfPageHTMLCode = "<tr><td colspan=""7"" align=""center""><br>"
    strEndOfPageHTMLCode = strEndOfPageHTMLCode & "<button class='clsButtonLarge' name=""ADDOWNER"" onclick=""window.location.href='" & mam_GetDictionary("OWNER_ADD_DIALOG") & "?MDMReload=TRUE" & "'; return false;"">" & mam_GetDictionary("TEXT_ADD_OWNER_ACCOUNTS") & "</button>&nbsp;&nbsp;&nbsp;"
