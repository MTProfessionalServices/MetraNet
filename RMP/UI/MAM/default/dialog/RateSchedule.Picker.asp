...
PRIVATE FUNCTION Form_LoadProductView(EventArg) ' As Boolean
  ...
  Form("NextPage") = session("RuleEditorCall")
  
  Set objMTProductCatalog       = GetProductCatalogObject
  
  Set objParamTable = objMTProductCatalog.GetParamTableDefinition(Clng(Form("PT_ID")))
  Set ProductView.Properties.RowSet = objParamTable.GetRateSchedulesAsRowset 
  ...
  Set Form.Grid.FilterProperty          	        = ProductView.Properties("pl_nm_name") ' Set the property on which to apply the filter  
  
  ProductView.Properties("rs_nm_desc").Caption      = mam_getDictionary("TEXT_KEYTERM_RATE_SCHEDULE")
  ProductView.Properties("pi_nm_name").Caption      = mam_getDictionary("TEXT_KEYTERM_PRICEABLE_ITEM")
  ProductView.Properties("pl_nm_name").Caption      = mam_getDictionary("TEXT_KEYTERM_PRICE_LIST")
  ProductView.Properties("dt_start").Caption        = mam_getDictionary("TEXT_RATE_START_DATE")  
  ProductView.Properties("dt_end").Caption          = mam_getDictionary("TEXT_RATE_END_DATE")    
