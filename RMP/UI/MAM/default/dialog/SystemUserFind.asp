...
Form.RouteTo			            = mam_GetDictionary("SYSTEMUSER_FIND_BROWSER")
...
PRIVATE FUNCTION Form_Initialize(EventArg) ' As Boolean
  ...
  ' Allow search on currency enumtype
  Call mam_Account_ChangeCurrencyTypeToEnumType()
  Service.Properties("Currency").Value = ""
...
PRIVATE FUNCTION Ok_Click(EventArg) ' As Boolean
  ...
  strRouteto = strRouteto & AddSearchFieldToQueryString(Service.Properties("Currency"),                 "Currency") 
  ...
  Else
      ...
      'Redirect to the correct dialog
      strRouteto    = mam_GetDictionary("SYSTEMUSER_FIND_BROWSER") & "?SearchDate=" & CDate(strDate) & "&ShowBackSelectionButton=TRUE&AdvancedFind=TRUE" & strRouteto
...
END FUNCTION
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
' Function    : ToggleFind_Click(EventArg)                                  '
' Description : Call the SE_Find dialog.                                    '
' Inputs      :                                                             '
' Outputs     :                                                             '
'''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''''
Function ToggleFind_Click(EventArg)
  Call mdm_Terminate()
  Call Response.Redirect(mam_GetDictionary("ADVANCED_FIND_DIALOG"))
  ToggleFind_Click = true
End Function
