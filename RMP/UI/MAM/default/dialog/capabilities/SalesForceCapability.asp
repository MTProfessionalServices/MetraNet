	    ...
	    Select Case UCase(atomic.capabilityType.name)
	        ...
	        objDyn.Add "0", "0", , , "[TEXT_CURRENT_NODE]"
			    ...
			    Service.Properties("MTWILDCARD" & nCount).AddValidListOfValues objDyn	
				  ...
				  strHTML = strHTML & "	 	  <input id='MTPATHCAPABILITY" & nCount & "' name='MTPATHCAPABILITY" & nCount & "' type='text' size='40'><a href=""JavaScript:getFrameMetraNet().getSelection('setSelection','MTPATHCAPABILITY" & nCount & "');"" name='selMTPATHCAPABILITY" & nCount & "' id='selMTPATHCAPABILITY" & nCount & "'><img src='/Res/Images/icons/find.png' alt='Select Account' border='0' /></a>"       
					strHTML = strHTML & "		</td>"
					strHTML = strHTML & "</tr>"
					strHTML = strHTML & "<tr>"
					strHTML = strHTML & "	 <td align='center' colspan='2' class='clsStandardText'>"
					strHTML = strHTML & "	   <input type='radio' name='MTWILDCARD" & nCount & "' value='0'>[TEXT_CURRENT_NODE]&nbsp;&nbsp;"
					strHTML = strHTML & "		 <input type='radio' name='MTWILDCARD" & nCount & "' value='1'>[TEXT_DIRECT_DESCENDANTS]&nbsp;&nbsp;"
					strHTML = strHTML & "		 <input type='radio' name='MTWILDCARD" & nCount & "' value='2'>[TEXT_ALL_DESCENDANTS]&nbsp;&nbsp;"
					strHTML = strHTML & "	 </td>"
					strHTML = strHTML & "</tr>"				 
              ...
              If strPath = "/" or strPath = "" Then
                Service.Properties("MTPATHCAPABILITY" & nCount) = mam_GetDictionary("TEXT_USERS") & " (1)"
