...
mstrXML = mobjViewAllRates.GetAllRatesByPriceableItemType(TRUE, TRUE, TRUE, FALSE)' Localized?, Progress?, Calendar?, LocalTime?, timezoneID
...
mstrPathXSL = server.MapPath(Application("APP_HTTP_PATH") & "/default/dialog/GetratesByByPriceableItemType.xsl")
