...
mstrXML = mobjViewAllRates.GetAllRatesForProductOffering(CLng(request.queryString("ID")), TRUE, TRUE, TRUE, FALSE)' Localized?, Progress?, Calendar?, LocalTime?, timezoneID
...
mstrPathXSL = server.MapPath(Application("APP_HTTP_PATH") & "/default/dialog/GetPORates.xsl")
