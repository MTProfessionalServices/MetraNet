...
<head>
    ...
    <frameset cols="284,*" framespacing="2" frameborder="no" name="fmeBottom">
        <frame src="BatchManagement.Statistics.Select.asp?Title=<%=server.urlencode(request("Title"))%>&BatchId=<%=server.urlencode(request("BatchId"))%>" name="fmeStatSelect" frameborder="No" scrolling="Auto" marginwidth="0" marginheight="0" framespacing="0">
