...
PRIVATE FUNCTION Form_LoadProductView(EventArg) ' As Boolean
  ...
  dim sBatchId
  sBatchId=Form("BatchId")
  if len(sBatchId) then
    '// Convert batchid to hex for database query
    dim objMSIXUtils
    set objMSIXUtils = CreateObject("MetraTech.Utils.MSIXUtilsInterop")
    sBatchId = "0x" & objMSIXUtils.DecodeUIDAsString(sBatchId)
  end if
  ...
  rowset.AddParam "%%ID_BATCH%%", sBatchId
