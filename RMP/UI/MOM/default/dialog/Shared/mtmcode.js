...
//    MTMDoc.open("text/html", "replace");
    ...
    MTMOutputString += 'bgcolor="' + MTMBGColor + '" text="' + MTMTextColor + '" link="' + MTMLinkColor + '" vlink="' + MTMLinkColor + '" alink="' + MTMLinkColor + '"><br>';
...
/////////////////////////////////////////////////////
//Function added to work around IE4 document.close() issue
function MTMReload() {
//  alert("Loaded: " + MTMLoaded + "  Reloaded: " + MTMReloaded);
  if(MTMLoaded && !MTMReloaded) {
    clearInterval(intIntervalID);
    parent.frames[MTMenuFrame].location.reload();
    MTMReloaded = true;
  }
}
///////////////////////////////////////////////////////
...
function MTMDisplayItem(item, last) {
  ...
  if(item.submenu) {
    ...
    var MTMfrm = "parent.frames['fmeMenuCode']";
...
//  tempString +=  '<a name="sub' + thisItem.number + '" href="javascript:parent.frames[\'code\'].myVoid();" onclick="' + thisCmd + '" onmouseover="window.status=\'' + thisText + '\';return true;" onmouseout="window.status=\'' + window.defaultStatus + '\';return true;"';
  tempString +=  '<a name="sub' + thisItem.number + '" href="javascript:parent.frames[\'fmeMenuCode\'].myVoid();" onclick="' + thisCmd + '" onmouseover="window.status=\'' + thisText + '\';return true;" onmouseout="window.status=\'' + window.defaultStatus + '\';return true;"';
...
function MTMakeImage(thisImage) {
  return('<img src="' + MTMPreHREF + MTMenuImageDirectory + thisImage + '" align="left" border="0" vspace="0" hspace="0" width="' + MTMIconWidth + '" height="' + MTMIconHeight + '">');
}
