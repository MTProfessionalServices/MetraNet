...
SafeForIncludesOnly("SmartViewerActiveX.asp")
%>
<%
...
<OBJECT ID="CRViewer"
	...
	CODEBASE="/mci/viewer/activeXViewer/activexviewer.cab#Version=8,0,0,224">
...
Sub Page_Initialize
	...
	if ScriptEngineMajorVersion < 2 then
		...
		CRViewer.ReportName = Location.Protocol + "//" + Location.Host + "/mci/mtreports/rptserver.asp"
	else
		Dim webSource
		Set webSource = CreateObject("WebReportSource.WebReportSource")
		webSource.ReportSource = webBroker
		webSource.URL = Location.Protocol + "//" + Location.Host + "/mci/mtreports/rptserver.asp"
