...
Sub WriteErrorString(sError)
  ...
  response.Write "        <TR>" & vbNewline
  response.Write "          <TD WIDTH=10 HEIGHT=16><IMG SRC=""" & session("VIRTUAL_DIR") & "/us/images/spacer.gif"" WIDTH=""10"" HEIGHT=""16"" BORDER=""0""></TD>" & vbNewline
  response.Write "          <TD VALIGN=""top""><IMG SRC=""" & session("VIRTUAL_DIR") & "/us/images/error.gif"" align=""center"" WIDTH=""38"" HEIGHT=""37"" BORDER=""0"" ></TD>" & vbNewline
  response.Write "          <TD class=""clsErrorText""><BR>"
  response.Write sError
  response.Write "</TD>" & vbNewline
  response.Write "          <TD WIDTH=10 HEIGHT=16><IMG SRC=""" & session("VIRTUAL_DIR") & "/images/spacer.gif"" WIDTH=""10"" HEIGHT=""16"" BORDER=""0""></TD>" & vbNewline
  response.Write "        </TR>" & vbNewline
  response.write "        <TR>" & vbNewline
...
Sub WriteErrorObject(objErr)
  ...
  response.write "            <TR>" & vbNewline
  response.write "              <TD WIDTH=""10"" HEIGHT=""16""><IMG SRC=""" & session("VIRTUAL_DIR") & "/images/spacer.gif"" WIDTH=""10"" HEIGHT=""16"" BORDER=""0""></TD>" & vbNewline
  response.write "              <TD VALIGN=""top""><IMG SRC=""" & session("VIRTUAL_DIR") & "/images/error.gif"" WIDTH=38 HEIGHT=37 BORDER=0></TD>" & vbNewline
  ...
  response.write "                </UL>" & vbNewline
  response.write "              </TD>" & vbNewline
  response.write "              <TD width=""10"" height=""16"" src=""" & session("VIRTUAL_DIR") & "/images/spacer.gif"" width=10 height=16 border=0></td>" & vbNewline
  response.write "            </TR>" & vbNewline
  response.write "            <TR>" & vbNewline
