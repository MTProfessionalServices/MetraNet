<%@ Page Title="MetraNet" Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" Inherits="BillMessageAccounts" CodeFile="BillMessageAccounts.aspx.cs"%>
...
<uc1:BreadCrumb ID="BreadCrumb1" runat="server" />
  ...
  //  });
    ...
    function onEdit(internalId, id)
    {
      if(<%=ChildGrid %>)
      {
        document.location.href = String.format("BillMessageAccount.aspx?EditChildRow=true&name={0}&id={1}&url={2}", entityName, internalId, referer);
      }
      else
      {
        document.location.href = String.format("BillMessageAccount.aspx?name={0}&id={1}&url={2}", entityName, internalId, referer);
      }
    }
    ...
    {          
        ...
        if(<%=ChildGrid %>)
         { 
          ...
          {        
             document.location.href = String.format("BillMessageAccount.aspx?name={0}&Association={1}&ParentId={2}&ParentName={3}&url={4}&NewOneToMany=true", entityName, associationValue, parentId, parentName, referer);
          }
  }
