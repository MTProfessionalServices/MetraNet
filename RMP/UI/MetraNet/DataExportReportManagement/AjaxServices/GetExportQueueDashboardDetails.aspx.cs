...
public partial class DataExportReportManagement_AjaxServices_GetExportQueueDashboardDetails : MTListServicePage
{
  ...
  protected bool ExtractDataInternal(DataExportReportManagementServiceClient client, ref MTList<ExportReportInstance> items, int batchID, int limit)
  {
    try
    {
      ...
      client.GetExportQueueDashboard(ref items);
    }
  ...
  {
    using (new HighResolutionTimer("GetExportQueueDashboardDetailsAjax", 5000))
    {
