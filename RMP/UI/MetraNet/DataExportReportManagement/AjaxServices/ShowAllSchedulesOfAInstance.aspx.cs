...
public partial class DataExportReportManagement_AjaxServices_ShowAllSchedulesOfAInstance : MTListServicePage
{
  ...
  {
    using (new HighResolutionTimer("ShowAllSchedulesOfAInstance", 5000))
    {
