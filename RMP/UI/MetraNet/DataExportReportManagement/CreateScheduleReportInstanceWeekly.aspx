...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <!-- Title Bar -->
  <MT:MTTitle ID="MTTitle1" Text="Create Weekly Report Schedule" runat="server" meta:resourcekey="MTTitle1Resource1" /><br />
...
<!-- From Add Parameters Template -->
  <MTCDT:MTGenericForm ID="MTGenericForm1" runat="server" 
    ...
    meta:resourcekey="MTGenericForm1Resource1" EnableChrome="True"></MTCDT:MTGenericForm>
