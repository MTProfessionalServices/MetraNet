<%@ Page Title="Update Daily Report Schedule" Language="C#" MasterPageFile="~/MasterPages/NoMenuPageExt.master" AutoEventWireup="true" CodeFile="UpdateScheduleReportInstanceDaily.aspx.cs" Inherits="DataExportReportManagement_UpdateScheduleReportInstanceDaily" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <!-- Title Bar -->
  <MT:MTTitle ID="MTTitle1" Text="Update Daily Report Schedule" runat="server" meta:resourcekey="MTTitle1Resource1" /><br />
