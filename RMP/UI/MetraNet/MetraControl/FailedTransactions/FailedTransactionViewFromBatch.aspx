<%@ Page Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" CodeFile="FailedTransactionViewFromBatch.aspx.cs" Inherits="FailedTransactionViewFromBatch" Culture="auto" UICulture="auto" Title="<%$Resources:Resource,TEXT_TITLE%>" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
  ...
  <MT:MTFilterGrid ID="FailedTransactionList" runat="Server" ExtensionName="SystemConfig" 
    TemplateFileName="FailedTransactionFromButchLayout.xml">
  </MT:MTFilterGrid>
  ...
  <div id="loader" style="top: 50%; left: 50%; width: 100px; height: 30px; position: absolute; margin-top: -65px; margin-left: -15px;">
  </div>
</asp:Content>
