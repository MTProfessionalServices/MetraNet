<%@ Page Title="<%$Resources:Resource,TEXT_TITLE_METRACONTROL%>" Language="C#" MasterPageFile="~/MasterPages/NoMenuPageExt.master" AutoEventWireup="true" Inherits="FileManagementArgs" CodeFile="FileManagementArgs.aspx.cs" Culture="auto" UICulture="auto"  %>
...
<br /><br />
  ...
  <script type="text/javascript">
    ...
    {
      document.location.href = String.format("/MetraNet/MetraControl/FileManagement/FileManagementArg.aspx?name={0}&id={1}&url={2}", entityName, internalId, referer);
    }
    ...
    {
       document.location.href = String.format("/MetraNet/MetraControl/FileManagement/FileManagementArg.aspx?name={0}&Association={1}&ParentId={2}&ParentName={3}&url={4}&NewOneToMany=true", entityName, associationValue, parentId, parentName, referer);
    }
