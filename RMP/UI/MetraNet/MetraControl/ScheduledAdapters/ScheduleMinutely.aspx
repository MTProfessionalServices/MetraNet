<%@ Page Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" CodeFile="ScheduleMinutely.aspx.cs" Inherits="ScheduleMinutely" Title="MetraNet" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<script type="text/javascript">
  ...
  <MT:MTPanel ID="RecurrencePatternPanel" runat="server" meta:resourcekey="RecurrencePatternPanelResource1" Text="Recurrence Pattern" Width="600">
       ...
       <MT:MTDropDown ID="ddHours" runat="server" AllowBlank="True" Label="Hour(s)"
        TabIndex="210" ControlWidth="40" ListWidth="40" HideLabel="False" LabelSeparator=":" Listeners="{}"
      ...
      <MT:MTDropDown ID="ddMinutes" runat="server" AllowBlank="True" Label="Minute(s)"
        TabIndex="220" ControlWidth="40" ListWidth="40" HideLabel="False" LabelSeparator=":" Listeners="{}"
        meta:resourcekey="ddMinutesResource1" ReadOnly="False" LabelWidth="140">
      </MT:MTDropDown>    
   </MT:MTPanel> 
      ...
      <table cellspacing="0">
        <tr>
          <td  class="x-panel-btn-td">
            <MT:MTButton ID="btnSave" runat="server" Text="<%$ Resources:Resource,TEXT_SAVE %>" OnClientClick="return validate();" OnClick="btnSave_Click" TabIndex="250" />      
          </td>
          <td  class="x-panel-btn-td">
            <MT:MTButton ID="btnCancel" runat="server" Text="<%$ Resources:Resource,TEXT_CANCEL %>" OnClientClick="goBack();" CausesValidation="False" TabIndex="260" />
          </td>
        </tr>
      </table> 
      </center>    
