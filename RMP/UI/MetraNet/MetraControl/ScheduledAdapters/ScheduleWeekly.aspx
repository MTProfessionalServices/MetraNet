<%@ Page Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" CodeFile="ScheduleWeekly.aspx.cs" Inherits="ScheduleWeekly" Title="MetraNet" meta:resourcekey="PageResource1" Culture="auto" UICulture="auto" %>
...
<script type="text/javascript">
  ...
  <MT:MTPanel ID="RecurrencePatternPanel" runat="server" meta:resourcekey="RecurrencePatternPanelResource1" Text="Recurrence Pattern" Width="600" >
     ...
     <MT:MTDropDown ID="ddWeeks" runat="server" AllowBlank="False" Label="Week(s)"
        TabIndex="100" ControlWidth="40" ListWidth="40" HideLabel="False" LabelSeparator=":" Listeners="{}"
        meta:resourcekey="ddWeeksResource1" ReadOnly="False" LabelWidth="140">    
      </MT:MTDropDown>      
      <MT:MTSuperBoxSelect ID="sbWeekly" runat="server" FieldLabel="on" ControlWidth="200" Width="200" LabelSeparator=":" LabelWidth="140" VType="null"
        meta:resourcekey="sbWeeklyResource1" AllowBlank="False" TabIndex="110" >
      </MT:MTSuperBoxSelect>            
      ...
      <table cellspacing="0">
        <tr>
          <td  class="x-panel-btn-td">
            <MT:MTButton ID="btnSave" runat="server" Text="<%$ Resources:Resource,TEXT_SAVE %>" OnClick="btnSave_Click" OnClientClick="return onSaveClick();" TabIndex="140"/>      
          </td>
          <td  class="x-panel-btn-td">
            <MT:MTButton ID="btnCancel" runat="server" Text="<%$ Resources:Resource,TEXT_CANCEL %>" OnClientClick="goBack();" CausesValidation="False" TabIndex="150"/>
          </td>
        </tr>
      </table> 
      </center>    
