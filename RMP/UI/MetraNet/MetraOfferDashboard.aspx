<%@ Page Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" CodeFile="MetraOfferDashboard.aspx.cs" Inherits="MetraOfferDashboard" Title="MetraOffer Dashboard" Culture="auto" UICulture="auto" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
   ...
   <link rel="stylesheet" type="text/css" href="/Res/Ext/resources/css/xtheme-gray.css" />
...
<MT:MTTitle ID="MTTitle1" Text="Product Dashboard" runat="server" meta:resourcekey="MTTitle1Resource1" />
<br />



             <MT:MTPanel ID="AnalyticsTopMRR" runat="server" Text="Top MRR" Collapsed=true>
                   <table>
                        <tr >
               ...
               <MT:MTPanel ID="AnalyticsTopSubscriptions" runat="server" Text="Top Subscriptions" Collapsed=true>
                   <table>
                        <tr >
                   ...
                   <MT:MTPanel ID="AnalyticsTopNewSubscribers" runat="server" Text="Top Offerings Selected By New Subscribers" Collapsed=true>
                   <table>
                        <tr >
