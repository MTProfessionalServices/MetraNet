<%@ Page Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" Inherits="Payments_ACHRemove" Title="MetraNet" Culture="auto" meta:resourcekey="PageResource1" UICulture="auto" CodeFile="ACHRemove.aspx.cs" %>
<%@ Register Assembly="MetraTech.UI.Controls" Namespace="MetraTech.UI.Controls" TagPrefix="MT" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">  
  
  <MT:MTTitle ID="MTTitle1" runat="server" Text="Remove ACH" meta:resourcekey="MTTitle1Resource1" />
  <br />
  ...
  <asp:Label ID="lblErrorMessage" runat="server" CssClass="ErrorMessage" Text="Error Messages"
    ...
    <div class="InfoMessage" style="margin-left:120px;width:400px;">
      <MT:MTLabel Text="Are you sure you want to remove the ach account below?" runat="server" ID="lblConfirm" meta:resourcekey="lblConfirmResource1" />
      <p />
