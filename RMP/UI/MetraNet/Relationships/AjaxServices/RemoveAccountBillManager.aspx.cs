...
public partial class Relationships_AjaxServices_RemoveAccountBillManager : MTListServicePage
{
  protected void Page_Load(object sender, EventArgs e)
  {
    var response = new AjaxResponse();
    using (new HighResolutionTimer("RemoveAccountBillManager", 5000))
    {
      ...
      try
      {
        ...
        string id = Request.Params["ids"];
          ...
          client.RemoveAccountBillManager(mgr); ;
        response.Success = true;
        response.Message = "Successfully removed account bill manager.";
        client.Close();
        client = null;
      }
