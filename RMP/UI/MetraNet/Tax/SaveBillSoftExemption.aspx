<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPages/PageExt.master" AutoEventWireup="true" CodeFile="SaveBillSoftExemption.aspx.cs" Inherits="Tax_SaveBillSoftExemption" meta:resourcekey="PageResource1" %>
<%@ Register Assembly="MetraTech.UI.Controls" Namespace="MetraTech.UI.Controls" TagPrefix="MT" %>

<asp:Content ID="Content1" ContentPlaceHolderID="ContentPlaceHolder1" Runat="Server">
<MT:MTPanel ID="MTPanel1" runat="server"
    Collapsed="False" Collapsible="True" EnableChrome="True" Text="Create BillSoft Exemption" meta:resourcekey="MTPanel1Resource1" >
    ...
    <MT:MTCheckBoxControl ID="cbApplyDescendents" runat="server" 
      ...
      meta:resourcekey="cbApplyDescendentsResource1" BoxLabel="Apply to Account Descendants" HideLabel="False" 
