              ...
              BEGIN
                 INSERT INTO t_export_reports
                   ( c_report_title, c_report_desc, c_rep_type, c_rep_def_source, c_rep_query_tag, c_prevent_adhoc_execution )
                   VALUES ( p_c_report_title, NVL(p_c_report_desc, p_c_report_title), p_c_rep_type, p_c_rep_def_source, p_c_rep_query_tag, p_c_prevent_adhoc_execution )
