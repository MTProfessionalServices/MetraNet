              ...
              BEGIN
                 ...
                 BEGIN
                    INSERT INTO t_export_workqueue
                      ( id_rep, dt_queued, dt_sched_run, c_use_database, c_rep_title, c_rep_type, c_rep_def_source, dt_last_run, dt_next_run, c_use_quoted_identifiers, c_rep_query_tag, c_rep_output_type, c_rep_distrib_type, c_rep_destn, c_destn_direct, c_destn_access_user, c_destn_access_pwd, c_exec_type, c_generate_control_file, c_control_file_delivery_locati, c_compressreport, c_compressthreshold, c_output_execute_params_info, c_ds_id, c_queuerow_source, c_param_name_values, c_output_file_name )
                      VALUES ( p_id_rep, p_system_datetime, p_system_datetime, '(local)', p_reptitle, p_repType, p_cRepDefSource, p_system_datetime - 1, p_system_datetime, NVL(p_usequotedidentifiers, 0), p_repQueryTag, p_outputType, p_deliveryType, p_destn, 0, p_ftpuser, p_ftpPassword, 'ad-hoc', p_createControlFile, p_controlFileDestn, p_compressReport, p_compressThreshold, p_outputExecParamsInfo, p_dsid, p_identifier, 
