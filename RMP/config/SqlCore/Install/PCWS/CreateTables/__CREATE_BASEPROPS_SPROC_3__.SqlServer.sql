      ...
      declare @id_desc_desc int
			exec UpsertDescriptionV2 @id_lang_code, @a_nm_display_name, NULL, @id_desc_display_name output
			exec UpsertDescriptionV2 @id_lang_code, @a_nm_name, NULL, @id_desc_name output
			exec UpsertDescriptionV2 @id_lang_code, @a_nm_desc, NULL, @id_desc_desc output
