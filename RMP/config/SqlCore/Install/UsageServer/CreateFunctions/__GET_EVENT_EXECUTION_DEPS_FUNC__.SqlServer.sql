...
/* ===========================================================
Populates #tmp_deps with the dependencies for the given @id_instances 
or all 'ReadyToRun' instances if @id_instances is NULL
=========================================================== */
CREATE PROCEDURE GetEventExecutionDeps(@dt_now DATETIME, @id_instances VARCHAR(4000))
AS
BEGIN
...
--SELECT * FROM #tmp_deps ORDER BY tx_orig_name ASC
