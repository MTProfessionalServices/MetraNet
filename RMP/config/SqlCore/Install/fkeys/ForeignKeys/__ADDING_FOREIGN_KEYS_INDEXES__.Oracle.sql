						...
						create index nm_name_idx on t_base_props (nm_name);
						...
						create index fk1idx_T_ACCOUNT_STATE_HISTORY on T_ACCOUNT_STATE_HISTORY (ID_ACC);
						create index fk1idx_T_GSUBMEMBER on T_GSUBMEMBER (ID_ACC);
						create index fk1idx_T_GSUBMEMBER_HISTORICAL on T_GSUBMEMBER_HISTORICAL (ID_ACC);
						create index fk1idx_T_IMPERSONATE on T_IMPERSONATE (ID_ACC);
						create index fk1idx_T_BILL_MANAGER on T_BILL_MANAGER (ID_ACC);
						create index fk1idx_T_PAYMENT_REDIR_HISTORY on T_PAYMENT_REDIR_HISTORY (ID_PAYEE);
						create index fk1idx_T_PL_MAP on T_PL_MAP (ID_PO);
						create index t_invoice_range_idx on t_invoice_range(id_interval);
						...
						create index fk1idx_t_cp_metadata on t_counter_params_metadata (id_counter_meta);
						...
						create index fk2idx_t_counteron ON t_counter (id_counter_type);
						create index fk2idx_t_counter_mapon on t_counter_map (id_pi);
						...
						create index fk1idx_t_adjustment_tranx on t_adjustment_transaction(id_aj_template);
						create index fk2idx_t_adjustment_tranx on t_adjustment_transaction(id_aj_instance);
						create index fk3idx_t_adjustment_tranx on t_adjustment_transaction(id_sess);
						...
						create index fk1idx_t_cparam_predicate on t_counter_param_predicate(id_counter_param);
						create index fk2idx_t_cp_predicate on t_counter_param_predicate(id_pv_prop);
						create index fk1idx_t_failed_tranx_msix on t_failed_transaction_msix(id_failed_transaction);
