          ...
          select
            ...
            coalesce(submitter.hierarchyname, (select nm_login from t_account_mapper where id_acc = id_submitter and rownum < 2)) as SubmitterName,
          ...
          from
            ...
            inner join
			      ...
			      left outer join
			      VW_HIERARCHYNAME submitter on sessions.id_submitter = owner.id_acc
            left outer join
            (select id_session, count(*) num_accounts_completed, n_retry_count from 
                ...
                where type.nm_enum_data = 'metratech.com/accounttemplate/DetailType/Update' and
            ...
            (select id_session, count(*) num_subs_completed, n_retry_count from 
                ...
                inner join
                t_enum_data status on detail.n_result = status.id_enum_data
                where type.nm_enum_data = 'metratech.com/accounttemplate/DetailType/Subscription' and
                (status.nm_enum_data = 'metratech.com/accounttemplate/DetailResult/Success' or
                 status.nm_enum_data = 'metratech.com/accounttemplate/DetailResult/Failure')
