	...
	begin
	if not table_exists('%%%NETMETERSTAGE_PREFIX%%%summ_delta_i_adj_usagedetail') then
  exec_ddl ('create table %%%NETMETERSTAGE_PREFIX%%%summ_delta_i_adj_usagedetail 
				(id_sess number(20),
	...
	if not table_exists('%%%NETMETERSTAGE_PREFIX%%%summ_delta_d_adj_usagedetail') then
  exec_ddl ('create table %%%NETMETERSTAGE_PREFIX%%%summ_delta_d_adj_usagedetail 
				(id_sess number(20),
				id_usage_interval number(10),
				am_currency nvarchar2(3),
				id_acc number(10),
