...
on au1.id_sess=child1.id_sess and au.id_usage_interval=child1.id_usage_interval
left outer join T_PV_AUDIOCONFFEATURE child2 with(readcommitted) on au1.id_sess=child2.id_sess and au1.id_usage_interval=child2.id_usage_interval
