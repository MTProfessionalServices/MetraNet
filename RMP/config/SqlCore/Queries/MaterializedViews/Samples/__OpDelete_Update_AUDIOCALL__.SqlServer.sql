...
from %%DELTA_DELETE_T_ACC_USAGE%% au1 with(readcommitted) left outer join %%DELTA_DELETE_T_PV_AUDIOCONFCONNECTION%% child1 with(readcommitted)
...
delete dm_1 from %%AUDIOCALL%% dm_1 inner join #SUMMARY_DELTA_DELETE_T_MV_AUDIOCALL tmp2 
      on dm_1.id_acc=tmp2.id_acc
