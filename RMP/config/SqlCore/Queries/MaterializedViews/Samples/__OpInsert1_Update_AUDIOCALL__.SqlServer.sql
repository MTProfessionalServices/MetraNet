...
from %%DELTA_INSERT_T_ACC_USAGE%% au1 with(readcommitted) left outer join T_PV_AUDIOCONFCONNECTION child1 
on au1.id_sess=child1.id_sess and au1.id_usage_interval=child1.id_usage_interval
left outer join T_PV_AUDIOCONFFEATURE child2 on au1.id_sess=child2.id_sess
and au1.id_usage_interval=child2.id_usage_interval
