      ...
      select * from t_rsched a, t_effectivedate b
	    ...
	    and (
	          (b.n_begintype = %%BEGIN_TYPE%% and b.n_begintype = 4 and b.n_beginoffset = %%START_OFFSET%%)
			    or
			      (b.n_begintype = %%BEGIN_TYPE%% and b.n_beginoffset != 4 and b.dt_start = to_date('%%START_DATE%%','mm/dd/yyyy hh24:mi:ss'))
          )
	    and (
	          (b.n_endtype = %%END_TYPE%%  and b.n_endtype = 4 and b.n_endoffset = %%END_OFFSET%%)
			    or
			      (b.n_endtype = %%END_TYPE%% and b.n_endoffset != 4 and b.dt_end = to_date('%%END_DATE%%','mm/dd/yyyy hh24:mi:ss'))
          )
