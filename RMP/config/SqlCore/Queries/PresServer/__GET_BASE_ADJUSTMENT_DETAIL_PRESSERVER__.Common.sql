...
au.Amount + (case when au.is_implied_tax = 'N' then (au.tax_federal + au.tax_state + au.tax_county + au.tax_local + au.tax_other) else 0 end)
          - (case when au.tax_informational = 'Y' then (au.tax_federal + au.tax_state + au.tax_county + au.tax_local + au.tax_other) else 0 end)  as UnadjustedAmountWithTax,
au.tax_federal,
au.tax_state,
au.tax_county,
au.tax_local,
