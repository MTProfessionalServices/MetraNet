			...
			(
						...
						where aa1.id_descendent=au.id_payee and au.id_acc=%%ID_ACC%% and %%TIME_PREDICATE%%
						and au.dt_session between aa1.vt_start and aa1.vt_end 
									--where a1.vt_start <= %%END_DATE%% and a1.vt_end > %%BEGIN_DATE%%
			)
			and
			aa1.id_ancestor=1
			and
			aa3.id_ancestor=1
			group by aa3.id_descendent, aa3.vt_start, aa3.vt_end, aa3.num_generations
