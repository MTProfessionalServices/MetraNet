...
/*  __GET_ADVANCE_DEBIT_CORRECTIONS__ */
SELECT
tmp.c_RCActionType,
tmp.c__AccountID,
...
/*  2) Correction is billed using payment history version that was (transaction time) */
/*  effective at the time the adapter for the interval containing the original charge was run */
