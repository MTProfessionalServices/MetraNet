...
%%INSERT_INTO_CLAUSE%%
SELECT 
/*  __GET_ADVANCE_DEBIT_CORRECTION_CANDIDATES__ */
...
/*  effective at the time the adapter for the interval which generated the associated charge was run. */
/*  3) Charge was billed using originator history version that was (transaction time) */
/*  effective at the time the adapter for the interval which generated the associated charge was run. */
