			...
			INSERT into %%TABLE_NAME%% (id_source_sess, tx_batch, id_sess, id_parent_sess, root, id_interval, id_view, tx_state, id_svc, id_parent_source_sess, id_payer)
            SELECT distinct 
            ...
            INNER JOIN t_enum_data ed on ed.nm_enum_data = f.tx_FailureServiceName
