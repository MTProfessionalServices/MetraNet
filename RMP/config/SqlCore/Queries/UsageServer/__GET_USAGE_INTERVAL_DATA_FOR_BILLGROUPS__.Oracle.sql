 ...
 /* __GET_USAGE_INTERVAL_DATA_FOR_BILLGROUPS__ */              
			...
			accounts as
			(
				select /*+ no_push_pred(unassigned) */
				...
				count (*) TotalPayingAcctsForInterval, aui.id_usage_interval         
				...
				where  nmspace.tx_typ_space = 'system_mps' and aui.id_usage_interval = %%ID_INTERVAL%%
