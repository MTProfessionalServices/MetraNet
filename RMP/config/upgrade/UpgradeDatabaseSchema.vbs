...
Const METRATECH_BIN_PATH        = "MetraTech\RMP\bin"
...
Function UpgradeDatabaseSQLFromV301
	...
	strFilename = strInstallDir & METRATECH_BIN_PATH & "installutiltest.exe"
	strArguements = " -InstExtDbTables " & strInstallDir & "rmp\config\upgrade querytags.xml"
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\Procedure.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\Procedure.txt"
...
Function UpgradeDatabaseSQLFromV211
	...
	writelog("*** Update Database Schema...***")	
	strFilename = strInstallDir & METRATECH_BIN_PATH & "installutiltest.exe"
	strArguements = " -InstExtDbTables " & strInstallDir & "rmp\config\upgrade\v21to301 querytagsb.xml"
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\v21to301\UpgradeprocB.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v21to301\UpgradeprocB.txt"
	strFilename = "osql.exe"
	strArguements = " -S " & strDBHostName & " -d " & strDBName & " -U " & strAdminID & " -P " & """" & strAdminPwd & """" & " -i " & strInFile & " -o " & strOutFile
