...
Const kDBState_DB_37_PRESENT		= "4.0"
...
Public Function Main() ' As Boolean
	...
	if (DBStatus = kDBState_DB_37_PRESENT) then
		' call the upgrade database function to upgrade from 4.0 Beta to 4.0 GA
...
Function UpgradeDatabaseSQLFromV40
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\v40Betato40GA\v40to40GA.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v40Betato40GA\v40to40GA.txt"
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\v40Betato40GA\Procedure.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v40Betato40GA\Procedure.txt"
	strFilename = "osql.exe"
	strArguements = " -l 3000 -S " & strDBHostName & " -d " & strDBName & " -U " & strAdminID & " -P " & """" & strAdminPwd & """" & " -i " & strInFile & " -o " & strOutFile
	intstatus = WshShell.Run(strfilename & strArguements,VBHide, true)
	...
	writelog("*** Upgraded Core Database from v4.0 Beta to v4.0 GA successfully ... ***")
