...
Function UpgradeDatabaseSQLFromV40
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\v40Betato401\v40to401.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v40Betato401\v40to401.txt"
	...
	strInFile = strInstallDir & "RMP\Config\Upgrade\v40Betato401\Procedure.sql"
	strOutFile = strInstallDir & "RMP\Config\Upgrade\v40Betato401\Procedure.txt"
	strFilename = "osql.exe"
	strArguements = " -l 3000 -S " & strDBHostName & " -d " & strDBName & " -U " & strAdminID & " -P " & """" & strAdminPwd & """" & " -i " & strInFile & " -o " & strOutFile
	intstatus = WshShell.Run(strfilename & strArguements,VBHide, true)
	...
	writelog("*** Upgraded Core Database from v4.0 Beta to v4.0.1 successfully ... ***")
