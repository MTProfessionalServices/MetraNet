...
/**************************************************************/
/    RMP\Config\DBINstall\AccHierarchies\Queries.xml
/**************************************************************/

PRINT N'Alter [dbo].[AddAccToHierarchy]'

USE [NetMeter]
GO

ALTER  procedure AddAccToHierarchy (@id_ancestor int,
@id_descendent int,
@dt_start  datetime,
@dt_end  datetime,
...
PRINT N'Alter [dbo].[BatchAccHierarchyCreation]'

ALTER procedure BatchAccHierarchyCreation
(
...
/**************************************************************/
/   RMP\Config\DBINstall\BusinessEntity\Queries.xml
/**************************************************************/

PRINT N'Alter [dbo].[GetLocalizedEntries]'

ALTER procedure GetLocalizedEntries 
