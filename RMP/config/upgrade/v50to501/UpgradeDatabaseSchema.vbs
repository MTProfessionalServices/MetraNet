...
'*
'* These functions upgrade MetraTech Platform database from V5.0 to V5.1
'*
'******************************************************************************************
...
Const kDBState_DB_50_PRESENT		= "5.0"
...
Public Function Main() ' As Boolean
	...
	if (DBStatus = kDBState_DB_50_PRESENT) then
		' call the upgrade database function to upgrade from 5.0 to 5.1
		UpgradeDatabaseSQLFromV50
	else 
...
Function UpgradeDatabaseSQLFromV50
	...
	writelog("*** Upgrading Core Database from v5.0 ... ***")

	writelog("*** Update Database Schema...***")	
	strInFile = strInstallDir & "RMP\config\upgrade\V50to501\v50to501.sql"
	strOutFile = strInstallDir & "RMP\config\upgrade\V50to501\v50to501.txt"
	...
	strInFile = strInstallDir & "RMP\Config\upgrade\V50to501\Procedure.sql"
	strOutFile = strInstallDir & "RMP\Config\upgrade\V50to501\Procedure.txt"
	strFilename = "osql.exe"
	strArguements = " -l 3000 -S " & strDBHostName & " -d " & strDBName & " -U " & strAdminID & " -P " & """" & strAdminPwd & """" & " -i " & strInFile & " -o " & strOutFile
	intstatus = WshShell.Run(strfilename & strArguements,VBHide, true)
	...
	writelog("*** Upgraded Core Database from v5.0 to 5.1 successfully ... ***")
