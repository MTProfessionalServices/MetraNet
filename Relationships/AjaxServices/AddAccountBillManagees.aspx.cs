...
public partial class Relationships_AjaxServices_AddAccountBillManagees : MTListServicePage
{
  protected void Page_Load(object sender, EventArgs e)
  {
    var response = new AjaxResponse();
    using (new HighResolutionTimer("AddAccountBillManagees", 5000))
    {
      ...
      try
      {
        ...
        client.AddBillManagees(UI.Subscriber.SelectedAccount._AccountID.Value, accountIds);
        response.Success = true;
        response.Message = "Successfully added managees.";
        client.Close();
        client = null;
      }
