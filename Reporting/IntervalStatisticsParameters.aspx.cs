...
public partial class IntervalStatisticsParameters : MTPage
{
    ...
    protected void btnOK_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            url = string.Format("ShowConfiguredReport.aspx?InternalId={0}&Extension={1}&QueryName={2}&GridLayoutName={3}&IntervalId={4}&BillGroupId={5}", 
                internalId, extension, queryName, gridLayoutName,
