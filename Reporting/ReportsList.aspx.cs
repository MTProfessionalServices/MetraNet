...
public partial class ReportsList : MTPage
{
    ...
    protected override void OnLoadComplete(EventArgs e)
    {
        ...
        // Handle Tenant Id logic
        if (isMaster)
        {
            TenantLibrary.SetupFilterGridForMaster(MTFilterGrid1);
        }
        else
        {
            TenantLibrary.SetupFilterGridForTenant(MTFilterGrid1);
        }
