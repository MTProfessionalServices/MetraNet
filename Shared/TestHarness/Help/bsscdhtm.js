...
//Do not try to write ininle styles for NS!  NS can not handle it and will not stop downloading the html page...
	   ...
	   strStyle += "<style>";
	   strStyle += "<!--"
	   strStyle += "div.WebHelpPopupMenu {position:absolute; left:0px; top:0px; z-index:4; visibility:hidden;}";
	   strStyle += "-->";
	   strStyle += "</style>";
	   document.write(strStyle);
	   document.write("<DIV CLASS='WebHelpPopupMenu' ID='PopupMenu'></DIV>");
	} else {  	   document.write("<DIV ID='PopupMenu' STYLE='position:absolute; left:0px; top:0px; z-index:4; visibility:hidden;'></DIV>");
           if (gbIE4) {
