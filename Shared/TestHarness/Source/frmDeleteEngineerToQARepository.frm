VERSION 5.00
Begin VB.Form frmDeleteEngineerToQARepository 
   ...
   End
End
Attribute VB_Name = "frmDeleteEngineerToQARepository"
...
Public Function OpenDialog() As Boolean
    ...
    If m_booOK Then
        ...
        If MsgBox(PreProcess(TESTHARNESS_MESSAGE_7050, "NAME", Engineers.Text), vbQuestion + vbYesNo, TESTHARNESS_MESSAGE_7052) = vbYes Then
