...
public partial class BEEdit : MTPage
{
 ...
 protected void Page_PreInit(object sender, EventArgs e)
  {
    string EditChildRow = String.IsNullOrEmpty(Request["EditChildRow"]) ? "false" : Request["EditChildRow"];
    if (EditChildRow == "true")
    {
  ...
  protected void Page_Load(object sender, EventArgs e)
  {
    ...
    if (Request["Name"].StartsWith("Core.UI", StringComparison.InvariantCultureIgnoreCase) && !UI.CoarseCheckCapability("MetraView Admin"))
    {
