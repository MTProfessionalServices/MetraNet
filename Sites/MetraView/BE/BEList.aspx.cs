// Usage:  http://localhost/*/BEList.aspx?Name=Core.OrderManagement.Order&Extension=Account
...
public partial class BEList : MTPage
{
    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        if (!IsPostBack)
        {
            ...
            MTTitle1.InnerText = BEName.Substring(BEName.LastIndexOf(".") + 1);
    ...
    private string CheckParameter(string parameter)
    {
        ...
        try
        {
            ...
            {
                MetraTech.SecurityFramework.ApiInput input = new MetraTech.SecurityFramework.ApiInput(parameter);
                MetraTech.SecurityFramework.SecurityKernel.AccessController.Api.ExecuteDefaultByCategory(MetraTech.SecurityFramework.AccessControllerEngineCategory.UrlController.ToString(), input).ToString();
            }

            result = parameter;
        }
        catch (MetraTech.SecurityFramework.AccessControllerException accessExp)
        {
