<%@ Page Title="<%$Resources:Resource,TEXT_TITLE%>" Language="C#" MasterPageFile="~/MasterPages/NoMenuPageExt.master" AutoEventWireup="true" Inherits="BEUnrelatedEntityList" CodeFile="BEUnrelatedEntityList.aspx.cs"%>
...
<div id="relship_grid" style="padding:10px"></div> 
 ...
 <script type="text/javascript">
    ...
    {      
      document.location.href = String.format("BEEdit.aspx?EditChildRow=true&name={0}&Association={1}&ParentId={2}&ParentName={3}&url={4}&NewOneToMany=true&Unrelated=true", entityName, associationValue, parentId, parentName, referer);
    }
    ...
    var parameters = {name: entityName, id: ids}; 
              ...
              Ext.Ajax.request({
                  ...
                  callback: function(options, success, response) {
                    if (success) {
                        window.opener.dataStore_<%= MyGrid1.ClientID %>.reload();                            
                        window.close();
                    }
                    else
                    {
