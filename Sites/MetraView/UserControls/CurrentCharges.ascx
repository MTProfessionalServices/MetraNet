...
<table width="100%" cellspacing="0" cellpadding="0">
  ...
  <tr>
    <td width="5%"></td>
    <td><asp:Localize ID="ImpliedTax" meta:resourcekey="ImpliedTax" runat="server">Included Tax</asp:Localize></td>
...
<table width="100%" cellspacing="0" cellpadding="0" >
  <tr>
    <td>
        ...
        <a style="text-decoration:none;cursor:pointer;" ext:position="closed" ext:indent="0">
        <asp:Localize ID="Tax" meta:resourcekey="Tax" runat="server">Tax</asp:Localize>
        </a>
    </td>
...
<table width="100%" cellspacing="0" cellpadding="0" >
  <tr>
    <td><asp:Localize ID="Localize1" meta:resourcekey="TaxAdjustments" runat="server">Tax Adjustments</asp:Localize></td>
