				...
				insert into t_language (id_lang_code, tx_lang_code, n_order, tx_description) values (840, 'us', 10, 'English')
				insert into t_language (id_lang_code, tx_lang_code, n_order, tx_description) values (276, 'de', 20, 'German')
				insert into t_language (id_lang_code, tx_lang_code, n_order, tx_description)values (392, 'jp', 70, 'Japanese')
				insert into t_language (id_lang_code, tx_lang_code, n_order, tx_description)values (250, 'fr', 30, 'French')
