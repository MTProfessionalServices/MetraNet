				...
				CREATE OR REPLACE procedure InsertBasePropsV2(
				id_lang_code int,
        ...
        id_desc_desc t_base_props.n_desc%type;
				begin
					UpsertDescriptionV2(id_lang_code, a_nm_display_name, NULL, id_desc_display_name) ;
					UpsertDescriptionV2(id_lang_code, a_nm_name, NULL, id_desc_name) ;
					UpsertDescriptionV2(id_lang_code, a_nm_desc, NULL, id_desc_desc) ;
