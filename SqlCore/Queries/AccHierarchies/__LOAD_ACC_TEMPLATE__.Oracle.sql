      ...
      select id_acc_template,id_folder,dt_crt,tx_name, tx_desc, nm_login, nm_space, b_ApplyDefaultPolicy
       from
		(select id_acc_template,id_folder,dt_crt,tx_name, tx_desc, nm_login, nm_space, 
