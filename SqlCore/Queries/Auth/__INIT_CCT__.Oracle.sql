				...
				SELECT 
				/* Query Tag: __INIT_CCT__ */
				cct.id_cap_type, RAWTOHEX(cct.tx_guid) tx_guid, cct.tx_name, cct.tx_desc, cct.tx_progid, cct.tx_editor, cct.csr_assignable,
		    ...
		    ,act.tx_progid atomic_tx_progid 
				...
				,act.id_cap_type atomic_id_cap_type, RAWTOHEX(act.tx_guid) atomic_tx_guid, act.tx_name atomic_tx_name, act.tx_desc atomic_tx_desc
