		       ...
		       SELECT rp_prms.id_param_name as IDParameterInstance, replace(rp_names.c_param_name,'%','') as ParameterNameInstance, rp_names.c_param_desc as ParameterDescriptionInstance, 
		       tpdfv.c_param_value as ParameterValueInstance, tpdfv.id_param_values as IDParameterValueInstance     
