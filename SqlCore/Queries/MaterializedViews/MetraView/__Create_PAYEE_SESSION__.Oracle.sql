  ...
  execute immediate 'CREATE TABLE %%PAYEE_SESSION%% (
	...
	execute immediate 'CREATE INDEX idx_%%PAYEE_SESSION%% ON %%PAYEE_SESSION%% (id_dm_acc, dt_session, id_view)';
	execute immediate 'create index idx2_%%PAYEE_SESSION%% on %%PAYEE_SESSION%% (id_dm_acc,id_acc,id_usage_interval,dt_session,id_se,id_view,am_currency)';
