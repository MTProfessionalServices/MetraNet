...
begin
	...
	dm_1.TotalImpliedTax = IsNULL(dm_1.TotalImpliedTax,0.0) - nvl(tmp2.TotalImpliedTax, 0.0),
    dm_1.TotalInformationalTax = IsNULL(dm_1.TotalInformationalTax,0.0) - nvl(tmp2.TotalInformationalTax, 0.0),
    dm_1.TotalImplInfTax = IsNULL(dm_1.TotalImplInfTax,0.0) - nvl(tmp2.TotalImplInfTax, 0.0),
	...
	dm_1.PrebillImpliedTaxAdjAmt = IsNULL((dm_1.PrebillImpliedTaxAdjAmt,0.0) - nvl(tmp2.PrebillImpliedTaxAdjAmt, 0.0),
    dm_1.PrebillInformationalTaxAdjAmt = IsNULL((dm_1.PrebillInformationalTaxAdjAmt,0.0) - nvl(tmp2.PrebillInformationalTaxAdjAmt, 0.0),
    dm_1.PrebillImplInfTaxAdjAmt = IsNULL((dm_1.PrebillImplInfTaxAdjAmt,0.0) - nvl(tmp2.PrebillImplInfTaxAdjAmt, 0.0), 
	...
	dm_1.PostbillImpliedTaxAdjAmt = IsNULL((dm_1.PostbillImpliedTaxAdjAmt,0.0) - nvl(tmp2.PostbillImpliedTaxAdjAmt, 0.0),
    dm_1.PostbillInformationalTaxAdjAmt = IsNULL((dm_1.PostbillInformationalTaxAdjAmt,0.0) - nvl(tmp2.PostbillInformationalTaxAdjAmt, 0.0),
    dm_1.PostbillImplInfTaxAdjAmt = IsNULL((dm_1.PostbillImplInfTaxAdjAmt,0.0) - nvl(tmp2.PostbillImplInfTaxAdjAmt, 0.0), 	
