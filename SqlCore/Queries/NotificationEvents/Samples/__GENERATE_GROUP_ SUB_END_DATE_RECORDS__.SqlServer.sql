...
FROM t_gsubmember gsubmember
  ...
  LEFT OUTER JOIN t_account_mapper tmap_for_partitioned_account ON tmap_for_partitioned_account.id_acc = gsubmember.id_acc and tmap_for_partitioned_account.nm_space = partition_owner.nm_login   
