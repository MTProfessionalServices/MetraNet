...
t_enum_data  join t_notification_event_types on Lower(nm_enum_data) = Lower('MetraTech.MetraNet.NotificationEvents/NotificationEventType/'+notification_event_name) 
