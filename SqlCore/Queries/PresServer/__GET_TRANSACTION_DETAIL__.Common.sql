      ...
      ,au.AtomicPrebillAdjustedAmount
      ,au.AtomicPostbillAdjAmt
      ,au.AtomicPostbillAdjustedAmount
      ,au.CompoundPreBillFedTaxAdjAmt
			,au.CompoundPrebillStateTaxAdjAmt
			,au.CompoundPrebillCntryTaxAdjAmt
			...
			,au.CompoundPostbillCntryTaxAdjAmt
			...
			,au.AtomicPrebillCntryTaxAdjAmt
			...
			,au.AtomicPostbillCntryTaxAdjAmt
	...
	(
        ...
        --                                 CompoundPrebillAdjedAmt always equals AtomicPrebillAdjustedAmount
        ...
        --                                AtomicPostbillAdjustedAmount always equals CompoundPostbillAdjedAmt
        -- PREBILL ADJUSTMENTS:
        */
        ...
        CASE WHEN (prebillajs.AdjustmentAmount IS NOT NULL AND prebillajs.c_status = 'A')	
            ...
            ELSE 0 END
            + 
            {fn IFNULL((ChildPreBillAdjustments.PrebillCompoundCntryTaxAdjAmt), 0.0)} AS CompoundPrebillCntryTaxAdjAmt,
        ...
        (CASE WHEN (prebillajs.AdjustmentAmount IS NOT NULL AND prebillajs.c_status = 'A')	
            THEN prebillajs.aj_tax_county
            ELSE 0 END) AS AtomicPrebillCntryTaxAdjAmt,
       ...
       (CASE WHEN (postbillajs.id_adj_trx IS NOT NULL AND postbillajs.c_status = 'P')	
        ...
        CASE WHEN (postbillajs.AdjustmentAmount IS NOT NULL AND postbillajs.c_status = 'A')	
            ...
            ELSE 0 END
            + 
            {fn IFNULL((ChildPostBillAdjustments.PostbillCompoundCntryTaxAdjAmt), 0.0)} AS CompoundPostbillCntryTaxAdjAmt,
        ...
        (CASE WHEN (postbillajs.AdjustmentAmount IS NOT NULL AND postbillajs.c_status = 'A')	
            THEN postbillajs.aj_tax_county
            ELSE 0 END) AS AtomicPostbillCntryTaxAdjAmt,
        ...
        */
        ...
        /* adjustments to taxes */
	      ...
	      SUM(CASE WHEN (childprebillajs.AdjustmentAmount IS NOT NULL AND childprebillajs.c_status = 'A')	
	          ...
	          ELSE 0 END) PrebillCompoundCntryTaxAdjAmt, 
	    ...
	    SUM(CASE WHEN (childpostbillajs.AdjustmentAmount IS NOT NULL AND childpostbillajs.c_status = 'A')	
	        ...
	        ELSE 0 END) PostbillCompoundCntryTaxAdjAmt,
        ...
        INNER JOIN t_acc_usage_interval taui on au.id_usage_interval = taui.id_usage_interval AND taui.id_acc = au.id_acc
