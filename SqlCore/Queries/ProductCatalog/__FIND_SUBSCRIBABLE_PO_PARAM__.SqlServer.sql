					...
					(select tx_desc as nm_desc from t_description	where id_desc = t_base_props.n_desc and id_lang_code=@idLangcode) nm_desc,
          (select tx_desc as nm_display_name from t_description	where id_desc = t_base_props.n_display_name and id_lang_code=@idLangcode) nm_display_name,
