		...
		select id_prop,nm_display_name, cast(id_acc as number(10,0)) as id_acc, vt_start, vt_end, n_kind, nm_servicedef, max_unit_value, min_unit_value, nm_Unit_name, b_charge_per_participant from (  
