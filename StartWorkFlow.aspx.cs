    ...
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        switch (WorkflowName)
        {
            ...
            case "AddPartitionWorkflow":
                {
                    AddPartitionEvents_StartAddPartition_Client addPartitionClient = new AddPartitionEvents_StartAddPartition_Client();
                    addPartitionClient.In_AccountId = new AccountIdentifier(UI.User.AccountId);
