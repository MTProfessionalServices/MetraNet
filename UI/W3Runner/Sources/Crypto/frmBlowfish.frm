...
Begin VB.Form frmBlowfish 
   Caption         =   "Blowfish Testbed Demo Version 5"
   ClientHeight    =   7110
   ClientLeft      =   60
   ClientTop       =   345
   ClientWidth     =   6240
   ...
   Begin VB.Label Label6 
      Alignment       =   2  'Center
      Caption         =   "Copyright (C) 2000-2 DI Management Services Pty Ltd <www.di-mgt.com.au>"
      Height          =   495
      Left            =   1350
      TabIndex        =   13
      Top             =   6525
...
Private Sub cmdEncrypt_Click()
    strCipher = blf_StringEnc(Me.txtPlain)
    Me.txtCipher = strCipher
    Me.txtCipherHex = cv_HexFromString(strCipher)
    Me.txtCipher64 = EncodeStr64(strCipher)
    Me.cmdDecrypt.Enabled = True
End Sub

Private Sub cmdDecrypt_Click()
    Me.txtDecrypt = blf_StringDec(strCipher)
End Sub
