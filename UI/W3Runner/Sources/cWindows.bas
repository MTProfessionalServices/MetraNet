...
' Win32 API Declarations, Structures, and Public CONSTants
Public Declare Function CreateCompatibleDC Lib "gdi32" (ByVal hdc As Long) As Long
Public Declare Function CreatePen Lib "gdi32" (ByVal nPenStyle As Long, ByVal nWidth As Long, ByVal crColor As Long) As Long
Public Declare Function CreateCompatibleBitmap Lib "gdi32" (ByVal hdc As Long, ByVal nWidth As Long, ByVal nHeight As Long) As Long
Public Declare Function SelectObject Lib "gdi32" (ByVal hdc As Long, ByVal hObject As Long) As Long
Public Declare Function DeleteObject Lib "gdi32" (ByVal hObject As Long) As Long
Public Declare Function GetObj Lib "gdi32" Alias "GetObjectA" (ByVal hObject As Long, ByVal nCount As Long, lpObject As Any) As Long
...
Public Declare Function OleCreatePictureIndirect Lib "olepro32.dll" (Pic As PictDesc, RefIID As GUID, ByVal fPictureOwnsHandle As Long, IPic As IPicture) As Long
...
Public Declare Function FormatMessage Lib "kernel32" Alias "FormatMessageA" (ByVal dwFlags As Long, lpSource As Long, ByVal dwMessageId As Long, ByVal dwLanguageId As Long, ByVal lpBuffer As String, ByVal nSize As Long, Arguments As Any) As Long
...
Public Type M_SendMessageAnyByRefLParam
    m_string As String * 256
End Type
...
'
'Public Const URL_ESCAPE_SEGMENT_ONLY    As Long = &H2000 'Treat entire URL param as one URL segment
'Public Const URL_ESCAPE_PERCENT         As Long = &H1000
'Public Const URL_UNESCAPE_INPLACE       As Long = &H100000
'Public Const URL_INTERNAL_PATH          As Long = &H800000 'escape #'s in paths
...
Public Declare Function SendMessageAny Lib "user32" Alias "SendMessageA" (ByVal HWND As Long, ByVal wMsg As Long, ByVal wParam As Long, ByVal lParam As Any) As Long
Public Declare Function SendMessageAnyByRef Lib "user32" Alias "SendMessageA" (ByVal HWND As Long, ByVal wMsg As Long, ByVal wParam As Long, lParam As Any) As Long
