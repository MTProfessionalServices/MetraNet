...
Set ajtypes = ac.GetAdjustmentTypesForPITemplate(pitemplate)
...
inputs("UnusedPortChargesAdjustmentAmount") = 1.5
inputs("OverusedPortChargesAdjustmentAmount") = 2.5
inputs("CancelChargesAdjustmentAmount") = 3.4
inputs("ReservationChargesAdjustmentAmount") = 5.5
