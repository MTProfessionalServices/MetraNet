...
namespace MetraTech.Metering.Test
{
    ...
    public void TestSingleSessionSynchronous() 
    {
    ...
    public void TestSingleSessionASynchronous() 
    {
      // Create the session set and retrieve the batchUid
      string batchUid;
      ISessionSet sessionSet = CreateSessionSet(out batchUid, 1);
    ...
    public void TestSettingSessionPropertiesBeforeSessionSetProperties() 
    {
      // Create the session set and retrieve the batchUid
      string batchUid;
      ISessionSet sessionSet = CreateSessionSet(out batchUid, 1);
    ...
    [Test]
    [Category("FastSDK")]
    public void TestCompoundSessionSynchronous() 
    {
    ...
    [Test]
    [Category("FastSDK")]
    public void TestCompoundSessionASynchronous() 
    {
      int numChildServices = 2;
    ...
    [Test]
    [Category("FastSDK")]
    public void TestSetPropertiesWithUsername() 
    {
      // Create the session set and retrieve the batchUid
      string batchUid;
      ISessionSet sessionSet = CreateSessionSet(out batchUid, 1);
    ...
    public void TestInvalidDateLowerBound() 
    {
    ...
    public void TestInvalidDateUpperBound() 
    {
    ...
    public void TestValidDateLowerBound() 
    {
    ...
    public void TestValidDateUpperBound() 
    {
    ...
    public void TestAustralianDaylightSavingsTime() 
    {
    ...
    public void TestAustralianDaylightSavingsTime2() 
    {
