...
inner join agg_decision_info adi on adi.decision_unique_id = case when ad.id_decision like '%a' then substring(ad.id_decision, 1, len(ad.id_decision) - 1) else ad.id_decision end
