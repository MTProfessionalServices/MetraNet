...
PUBLIC FUNCTION mam_AccountFound(booYes) ' As Boolean
    ...
    If(booYes)Then
        ...
        strHTML = strHTML & "      <a target='main' onclick='parent.hierarchy.ClearHighlight();' href='" &  mam_GetDictionary("SUBSCRIBER_FOUND") & "'><IMG Border=0 src='/mam/default/localized/us/images/CloseWindow.gif' alt='" & mam_GetDictionary("TEXT_CLOSEWINDOW") & "'></a>"
        strHTML = strHTML & "    </td>"
        strHTML = strHTML & "  </tr>"
...
Public Function mam_SystemUserFound(bFound)
  ...
  if bFound then
    ...
    strHTML = strHTML & "      <a target=""main"" onclick=""parent.hierarchyUser.ClearHighlight();"" href=""" &  mam_GetDictionary("SUBSCRIBER_FOUND") & """><IMG Border=0 src=""/mam/default/localized/us/images/CloseWindow.gif"" alt=""" & mam_GetDictionary("TEXT_SYSTEM_USER") & """></a>"
    strHTML = strHTML & "    </td>"
    strHTML = strHTML & "  </tr>"
    strHTML = strHTML & "  <tr>"
