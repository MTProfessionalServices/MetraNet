...
PRIVATE FUNCTION Ok_Click(EventArg) ' As Boolean
  ...
  ' Account Types
  dim strAccountTypeName
  strAccountTypeName = "AccountTypeName='CORPORATEACCOUNT','CORESUBSCRIBER','DEPARTMENTACCOUNT','INDEPENDENTACCOUNT'"
  ...
  Else
      ...
      ElseIf Instr(Service.Properties("hierarchyDate").value, " ") > 0 Then
        strDate = Service.Properties("hierarchyDate")
      Else  
