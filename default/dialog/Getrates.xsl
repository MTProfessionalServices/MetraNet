...
<xsl:stylesheet xmlns:xsl="http://www.w3.org/TR/WD-xsl">
  ...
  <xsl:template match="/">
   <TABLE border="0" cellpadding="1" cellspacing="0" width="100%">
     <tr>
       <td Class="CaptionBar">View All Rates By Product Offering</td>
     </tr>
   </TABLE>
    
    <!-- Apply Product Offering Template -->
    <xsl:for-each select="/rates/ProductOffering">
 ...
 <!-- Priceable Item Template -->
  ...
  <xsl:template match="default_actions">
      ...
      <tr>      
        ...
        <td class="clsRateTableText" align="right"><xsl:value-of select="prop_name" />
