    ...
    Select Case Form.Grid.Col
         ...
         Case 1
            ...
            HTML_LINK_EDIT = HTML_LINK_EDIT  & "<A HRef='" & mam_GetDictionary("OWNED_UPDATE_DIALOG") & "?Update=TRUE&id=" &  ProductView.Properties("id_owned") 
						...
						HTML_LINK_EDIT = HTML_LINK_EDIT  & "&OldStartDate=" &  mdm_Format(ProductView.Properties("VT_Start"), mam_GetDictionary("DATE_FORMAT"))
						HTML_LINK_EDIT = HTML_LINK_EDIT  & "&OldEndDate=" & mdm_Format(ProductView.Properties("VT_End"), mam_GetDictionary("DATE_FORMAT"))
