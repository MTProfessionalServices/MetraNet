...
session("CANCEL_ROUTETO") = mam_GetDictionary("PAYER_SETUP_HISTORY_DIALOG")
         ...
         Case 1
            ...
            HTML_LINK_EDIT = HTML_LINK_EDIT  & "<A HRef='" & mam_GetDictionary("PAYER_UPDATE_DIALOG") & "?Update=TRUE&id=" &  ProductView.Properties("ID_Payee") 
						...
						HTML_LINK_EDIT = HTML_LINK_EDIT  & "&OldEndDate=" & ProductView.Properties("VT_End")
 						HTML_LINK_EDIT = HTML_LINK_EDIT  & "&PayerID=" & ProductView.Properties("id_payer")
        ...
        Case 2
            mdm_NoTurnDownHTML EventArg ' Takes Care Of Removing the 
				Case 3
						...
						HTML_LINK_EDIT = HTML_LINK_EDIT & mam_GetNameIDLink(ProductView.Properties("DISPLAYNAME"), ProductView.Properties("id_payer"), Empty, ProductView.Properties("c_folder"))
						HTML_LINK_EDIT = HTML_LINK_EDIT  & "</td>"
...
PRIVATE FUNCTION Form_DisplayEndOfPage(EventArg) ' As Boolean
    ...
    strEndOfPageHTMLCode = strEndOfPageHTMLCode & "<button class='clsButtonMedium' name=""ADDPAYER"" onclick=""window.location.href='" & mam_GetDictionary("PAYER_UPDATE_DIALOG") & "?MDMReload=TRUE&NewPayer=TRUE&ID=" & mam_GetSubscriberAccountID() & "'"">" & "Add Payer" & "</button>&nbsp;&nbsp;&nbsp;"
