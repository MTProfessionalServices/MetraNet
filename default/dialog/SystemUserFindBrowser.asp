    ...
    If DisplayRow(EventArg) Then
      ...
      Select Case Form.Grid.Col
          Case 1
             ...
             ' Else
                strSelectorHTMLCode   = Replace(strSelectorHTMLCode,"[SYNC]","<a target='secret' Name='butSyncRow[ROW]' href='[FIND_ACCOUNT_IN_HIERARCHY_DIALOG]?IsSystemUser=TRUE&ID=" & ProductView.Properties.RowSet.Value("_AccountId") & "'><img BORDER='0' LOCALIZED='true' SRC='/mam/default/localized/us/images/sync.gif' ALT='Find Account in Hierarchy'></a>")
             ' End IF
