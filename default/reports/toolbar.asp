...
if LastPageNumber <> ""  and (CurrentPageNumber = LastPageNumber) then
	...
	nextlink = ""
	lastlink = ""
	if CLng(CurrentPageNumber) > 1 then
		previouspage = CLng(CurrentPageNumber) - 1
	...
	if (CLng(lastknownpage) < CLng(CurrentPageNumber)) and LastPageNumber = "" then
		' remember the last known page
		session("lastknownpage") = CurrentPageNumber
		lastknownpage = CurrentPageNumber & "+"
	else 
	...
	nextpage = CLng(CurrentPageNumber) + 1
