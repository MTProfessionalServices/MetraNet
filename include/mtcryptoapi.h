...
#import <mscorlib.tlb> rename("ReportEvent", "MSReportEvent") rename ("_Module", "_ModuleCorlib") rename("value", "newvalue")
...
public:
	 ...
	 * Valid algorithm descriptors are "RC2", "RC4", "DES", "3DES", "AES".
...
public:
  ...
  int Initialize(MetraTech_Security_Crypto::CryptKeyClass keyClass, const std::string& szContainerName, bool bMachineKey, const std::string& szSource);
...
private:
  ...
  MetraTech_Security_Crypto::ICryptoManagerPtr cryptoManager;
  MetraTech_Security_Crypto::CryptKeyClass cryptKeyClass;
};
