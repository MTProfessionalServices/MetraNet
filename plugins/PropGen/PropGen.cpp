 ...
 * $Header$
 ***************************************************************************/
// PropGen.cpp : Implementation of DLL Exports.
...
//
//		Modify the custom build rule for PropGen.idl by adding the following 
//		files to the Outputs.
//			PropGen_p.c
//			dlldata.c
//		To build a separate proxy/stub DLL, 
//		run nmake -f PropGenps.mk in the project directory.
...
BEGIN_OBJECT_MAP(ObjectMap)
	OBJECT_ENTRY(CLSID_PropGenProcessor, CPropGenProcessor)
END_OBJECT_MAP()
