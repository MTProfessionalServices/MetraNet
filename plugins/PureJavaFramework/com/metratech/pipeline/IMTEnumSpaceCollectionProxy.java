...
/**
 * Proxy for COM Interface 'IMTEnumSpaceCollection'. Generated 7/24/00 5:03:12 PM
 ...
 */
public class IMTEnumSpaceCollectionProxy extends com.linar.jintegra.Dispatch implements IMTEnumSpaceCollection, java.io.Serializable {

  protected String getJintegraVersion() { return "1.3.4 SB002"; }

  static { JIntegraInit.init(); }

  public static final Class targetClass = com.metratech.pipeline.IMTEnumSpaceCollection.class;

  public IMTEnumSpaceCollectionProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTEnumSpaceCollection.IID, host, authInfo);
  }

  /** For internal use only */
  public IMTEnumSpaceCollectionProxy() {}

  public IMTEnumSpaceCollectionProxy(Object obj) throws java.io.IOException {
    super(obj, IMTEnumSpaceCollection.IID);
  }

  protected IMTEnumSpaceCollectionProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  public IMTEnumSpaceCollectionProxy(String CLSID, String host, boolean deferred) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTEnumSpaceCollection.IID, host, null);
  }

  protected IMTEnumSpaceCollectionProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("7f834f73-067c-11d4-95a1-00b0d025b121", IMTEnumSpaceCollectionProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
