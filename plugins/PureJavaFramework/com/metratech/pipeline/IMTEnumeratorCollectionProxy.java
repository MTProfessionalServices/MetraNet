...
/**
 * Proxy for COM Interface 'IMTEnumeratorCollection'. Generated 7/24/00 5:03:12 PM
 ...
 */
public class IMTEnumeratorCollectionProxy extends com.linar.jintegra.Dispatch implements IMTEnumeratorCollection, java.io.Serializable {

  protected String getJintegraVersion() { return "1.3.4 SB002"; }

  static { JIntegraInit.init(); }

  public static final Class targetClass = com.metratech.pipeline.IMTEnumeratorCollection.class;

  public IMTEnumeratorCollectionProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTEnumeratorCollection.IID, host, authInfo);
  }

  /** For internal use only */
  public IMTEnumeratorCollectionProxy() {}

  public IMTEnumeratorCollectionProxy(Object obj) throws java.io.IOException {
    super(obj, IMTEnumeratorCollection.IID);
  }

  protected IMTEnumeratorCollectionProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  public IMTEnumeratorCollectionProxy(String CLSID, String host, boolean deferred) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTEnumeratorCollection.IID, host, null);
  }

  protected IMTEnumeratorCollectionProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public void add  (
    ...
    while(true) {
      try {
        ...
        Object zz_parameters[] = { __MIDL_0018, zz_retVal };
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("68870841-03f4-11d4-95a0-00b0d025b121", IMTEnumeratorCollectionProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        ...
        new com.linar.jintegra.MemberDesc("add",
            ...
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("__MIDL_0018", 29, 2, 4, IMTEnumerator.IID, IMTEnumeratorProxy.class), 
