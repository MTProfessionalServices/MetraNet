...
/**
 * Proxy for COM Interface 'IMTEnumerator'. Generated 7/24/00 5:03:12 PM
 ...
 */
public class IMTEnumeratorProxy extends com.linar.jintegra.Dispatch implements IMTEnumerator, java.io.Serializable {

  protected String getJintegraVersion() { return "1.3.4 SB002"; }

  static { JIntegraInit.init(); }

  public static final Class targetClass = com.metratech.pipeline.IMTEnumerator.class;

  public IMTEnumeratorProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTEnumerator.IID, host, authInfo);
  }

  /** For internal use only */
  public IMTEnumeratorProxy() {}

  public IMTEnumeratorProxy(Object obj) throws java.io.IOException {
    super(obj, IMTEnumerator.IID);
  }

  protected IMTEnumeratorProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  public IMTEnumeratorProxy(String CLSID, String host, boolean deferred) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTEnumerator.IID, host, null);
  }

  protected IMTEnumeratorProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public void addValue  (
    ...
    while(true) {
      try {
        Object zz_retVal[] = { null };
        Object zz_parameters[] = { value, zz_retVal };
        vtblInvoke("addValue", 9, zz_parameters);
        return;
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public String getEnumspace  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    while(true) {
      try {
        String zz_retVal[] = { null };
        Object zz_parameters[] = { zz_retVal };
        vtblInvoke("getEnumspace", 10, zz_parameters);
        return (String)zz_retVal[0];
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public void setEnumspace  (
    ...
    while(true) {
      try {
        Object zz_retVal[] = { null };
        Object zz_parameters[] = { pVal, zz_retVal };
        vtblInvoke("setEnumspace", 11, zz_parameters);
        return;
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public String getEnumType  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    while(true) {
      try {
        String zz_retVal[] = { null };
        Object zz_parameters[] = { zz_retVal };
        vtblInvoke("getEnumType", 12, zz_parameters);
        return (String)zz_retVal[0];
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public void setEnumType  (
    ...
    while(true) {
      try {
        Object zz_retVal[] = { null };
        Object zz_parameters[] = { pVal, zz_retVal };
        vtblInvoke("setEnumType", 13, zz_parameters);
        return;
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public void writeSet  (
    ...
    while(true) {
      try {
        ...
        vtblInvoke("writeSet", 14, zz_parameters);
        return;
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public int numValues  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    while(true) {
      try {
        int zz_retVal[] = { 0 };
        Object zz_parameters[] = { zz_retVal };
        vtblInvoke("numValues", 15, zz_parameters);
        return zz_retVal[0];
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public String elementAt  (
    ...
    while(true) {
      try {
        String zz_retVal[] = { null };
        Object zz_parameters[] = { new Integer(__MIDL_0017), zz_retVal };
        vtblInvoke("elementAt", 16, zz_parameters);
        return (String)zz_retVal[0];
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public String getFQN  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    while(true) {
      try {
        String zz_retVal[] = { null };
        Object zz_parameters[] = { zz_retVal };
        vtblInvoke("getFQN", 17, zz_parameters);
        return (String)zz_retVal[0];
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public void clearValue  (
    ...
    while(true) {
      try {
        Object zz_retVal[] = { null };
        Object zz_parameters[] = { value, zz_retVal };
        vtblInvoke("clearValue", 18, zz_parameters);
        return;
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  public void clearValues  () throws java.io.IOException, com.linar.jintegra.AutomationException{
    while(true) {
      try {
        Object zz_retVal[] = { null };
        Object zz_parameters[] = { zz_retVal };
        vtblInvoke("clearValues", 19, zz_parameters);
        return;
      } catch(com.linar.jintegra.AutomationException automationException) {
        if(automationException.getCode() != 0x80010001L) {
          throw automationException;
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("bdf32815-027d-11d4-95a0-00b0d025b121", IMTEnumeratorProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        ...
        new com.linar.jintegra.MemberDesc("addValue",
            new Class[] { String.class, },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("value", 8, 2, 8, null, null), 
              new com.linar.jintegra.Param("", 24, 0, 8, null, null) }),
        ...
        new com.linar.jintegra.MemberDesc("getEnumType",
            ...
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("setEnumType",
            new Class[] { String.class, },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 2, 8, null, null), 
              new com.linar.jintegra.Param("", 24, 0, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("writeSet",
            ...
            new com.linar.jintegra.Param[] { 
              ...
              new com.linar.jintegra.Param("", 24, 0, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("numValues",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("__MIDL_0016", 22, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("elementAt",
            new Class[] { Integer.TYPE, },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("__MIDL_0017", 22, 2, 8, null, null), 
              new com.linar.jintegra.Param("pEnumValue", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("getFQN",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 8, 20, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("clearValue",
            new Class[] { String.class, },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("value", 8, 2, 8, null, null), 
              new com.linar.jintegra.Param("", 24, 0, 8, null, null) }),
        new com.linar.jintegra.MemberDesc("clearValues",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("", 24, 0, 8, null, null) }),
});  }
