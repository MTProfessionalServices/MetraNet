...
/**
 * Proxy for COM Interface 'IMTNameID'. Generated 7/24/00 5:03:12 PM
 ...
 */
public class IMTNameIDProxy extends com.linar.jintegra.Dispatch implements IMTNameID, java.io.Serializable {

  protected String getJintegraVersion() { return "1.3.4 SB002"; }

  static { JIntegraInit.init(); }

  public static final Class targetClass = com.metratech.pipeline.IMTNameID.class;

  public IMTNameIDProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTNameID.IID, host, authInfo);
  }

  /** For internal use only */
  public IMTNameIDProxy() {}

  public IMTNameIDProxy(Object obj) throws java.io.IOException {
    super(obj, IMTNameID.IID);
  }

  protected IMTNameIDProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  public IMTNameIDProxy(String CLSID, String host, boolean deferred) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTNameID.IID, host, null);
  }

  protected IMTNameIDProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  public int getNameID  (
    ...
    while(true) {
      try {
        ...
        vtblInvoke("getNameID", 7, zz_parameters);
        return zz_retVal[0];
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("49a30e80-3eaf-11d2-a1c5-006008c0e24a", IMTNameIDProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
