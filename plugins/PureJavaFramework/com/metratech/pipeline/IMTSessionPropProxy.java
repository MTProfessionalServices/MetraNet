...
/**
 * Proxy for COM Interface 'IMTSessionProp'. Generated 7/24/00 5:03:12 PM
 ...
 */
public class IMTSessionPropProxy extends com.linar.jintegra.Dispatch implements IMTSessionProp, java.io.Serializable {

  protected String getJintegraVersion() { return "1.3.4 SB002"; }

  static { JIntegraInit.init(); }

  public static final Class targetClass = com.metratech.pipeline.IMTSessionProp.class;

  public IMTSessionPropProxy(String CLSID, String host, AuthInfo authInfo) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTSessionProp.IID, host, authInfo);
  }

  /** For internal use only */
  public IMTSessionPropProxy() {}

  public IMTSessionPropProxy(Object obj) throws java.io.IOException {
    super(obj, IMTSessionProp.IID);
  }

  protected IMTSessionPropProxy(Object obj, String iid) throws java.io.IOException {
    super(obj, iid);
  }

  public IMTSessionPropProxy(String CLSID, String host, boolean deferred) throws java.net.UnknownHostException, java.io.IOException{
    super(CLSID, IMTSessionProp.IID, host, null);
  }

  protected IMTSessionPropProxy(String CLSID, String iid, String host, AuthInfo authInfo) throws java.io.IOException {
  ...
  static {
    com.linar.jintegra.InterfaceDesc.add("295fd850-f5ad-11d2-a1e3-006008c0e24a", IMTSessionPropProxy.class, null, 7, new com.linar.jintegra.MemberDesc[] {
        ...
        new com.linar.jintegra.MemberDesc("getType",
            new Class[] { },
            new com.linar.jintegra.Param[] { 
              new com.linar.jintegra.Param("pVal", 3, 20, 0, null, null) }),
});  }
}
