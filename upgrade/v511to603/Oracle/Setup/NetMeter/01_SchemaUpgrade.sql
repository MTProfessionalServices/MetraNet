...
ALTER TABLE TMP_DISCOUNT_3
 ADD (id_pi_instance  NUMBER(10) NOT NULL);

ALTER TABLE TMP_DISCOUNT_4
 ADD (id_pi_instance  NUMBER(10) NOT NULL);

ALTER TABLE TMP_DISCOUNT_5
 ADD (id_pi_instance  NUMBER(36,0) NOT NULL);
