...
IF  EXISTS (SELECT * FROM sys.procedures WHERE object_id = OBJECT_ID(N'AddAccToHierarchy') AND type in (N'P'))
	DROP PROCEDURE AddAccToHierarchy
GO

create  procedure AddAccToHierarchy 
(
	@id_ancestor int,
	@id_descendent int,
	@dt_start  datetime,
