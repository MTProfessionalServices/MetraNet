...
Important: If you want performance related changes, that are time-consuming due to indexes recreation
extract "20_Perf_tunning.sql" file out of "001" folder.
You may execute it separately after upgrading DB

1. Run 02_DropExtraFiles.bat to remove extra installation Sql files;
