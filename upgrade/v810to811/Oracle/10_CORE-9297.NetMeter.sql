...
CREATE OR REPLACE PROCEDURE CreateAnalyticsDataMart(p_dt_now date, p_id_run int, p_nm_currency nvarchar2, p_nm_instance nvarchar2, p_n_months int, p_STAGINGDB_prefix nvarchar2)
   AUTHID CURRENT_USER
IS
